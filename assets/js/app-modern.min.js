        ...
        case "flaticon":
          function getFlaticon() {
            $http({
              method: "GET",
              url:
                "https://api.flaticon.com/v3/search/icons/id??q=" +
                encodeURIComponent(search) +
                "&page=" +
                $scope.resource.flaticon.filter.currentPage +
                "&limit=" +
                $scope.resource.flaticon.filter.perPage,
              headers: {
              ...
              function successCallback(response) {
                ...
                $scope.resource.flaticon.filter.totalPage = Math.ceil(
                  data.metadata.total / $scope.resource.flaticon.filter.perPage
                );
              },
              function errorCallback(response) {
