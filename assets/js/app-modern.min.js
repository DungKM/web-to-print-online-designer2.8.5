...
var appConfig = {
  ...
  domainChanged: false,
  init: function () {
    this.mediaUrl = this.localMode
      ? "http://localhost/nbmedia/v1"
      : "https://studio.cmsmart.net/v1";
    this.domainChanged =
      NBDESIGNCONFIG.nbdesigner_fix_domain_changed == "yes" ? true : false;
  ...
  loadAllDesign:
    NBDESIGNCONFIG.nbdesigner_enable_load_all_design == "yes" ? true : false,
};
...
var photoFrames = [
  ...
  { areas: '"a a b" "a a c" "e d c"', rows: "", columns: "" },
  {
    areas: '"a c c" "b c c" "d d e"',
    rows: "1fr 1fr 2fr",
    columns: "1fr 1fr 2fr",
  },
  { areas: '"a e e" "b e e" "c c d"', rows: "", columns: "1fr 1fr 2fr" },
  {
  ...
  { areas: '"a b c" "a d c" "e e e"', rows: "", columns: "3fr 5fr 3fr" },
  { areas: '"a c c" "a d e" "b d e"', rows: "", columns: "" },
  { areas: '"a c d" "b c e"', rows: "", columns: "" },
  { areas: '"a a b b" "c d d e"', rows: "", columns: "2fr 1fr 1fr 2fr" },
  { areas: '"a b" "c c" "d e"', rows: "", columns: "" },
  { areas: '"a a a a" "b c d e"', rows: "3fr 1fr", columns: "" },
  { areas: '"a b c d e f"', rows: "", columns: "" },
  { areas: '"a" "b" "c" "d" "e" "f"', rows: "", columns: "" },
  { areas: '"a b c" "d e f"', rows: "", columns: "" },
  { areas: '"a b" "c d" "e f"', rows: "", columns: "" },
  { areas: '"a a a a a" "b c d e f"', rows: "2fr 1fr", columns: "" },
  { areas: '"a b c d e" "f f f f f"', rows: "1fr 2fr", columns: "" },
  { areas: '"a b" "a c" "a d" "a e" "a f"', rows: "", columns: "2fr 1fr" },
  { areas: '"a f" "b f" "c f" "d f" "e f"', rows: "", columns: "1fr 2fr" },
  { areas: '"a a b b" "c d e f"', rows: "2fr 1fr", columns: "" },
  { areas: '"a b c d" "e e f f"', rows: "1fr 2fr", columns: "" },
  { areas: '"a c" "a d" "b e" "b f"', rows: "", columns: "2fr 1fr" },
  { areas: '"a e" "b e" "c f" "d f"', rows: "", columns: "1fr 2fr" },
  { areas: '"a b b" "c b b" "d e f"', rows: "", columns: "" },
  { areas: '"a a e" "a a f" "b c d"', rows: "", columns: "" },
  { areas: '"a b c" "d d e" "d d f"', rows: "", columns: "" },
  { areas: '"a b c" "d f f" "e f f"', rows: "", columns: "" },
  { areas: '"a b c" "d b f" "d e f"', rows: "", columns: "" },
  { areas: '"a a b" "c d d" "e e f"', rows: "", columns: "" },
  {
  ...
  { areas: '"a a b c" "a a d d" "f e d d"', rows: "", columns: "" },
  {
  ...
  { areas: '"a a b" "a a c" "f e d"', rows: "", columns: "" },
  {
  ...
  { areas: '"a a a a a a" "b c d e f g"', rows: "3fr 1fr", columns: "" },
  { areas: '"a b c d e f" "g g g g g g"', rows: "1fr 3fr", columns: "" },
  { areas: '"a a a" "b c d" "e f g"', rows: "3fr 1fr 1fr", columns: "" },
  { areas: '"a b c" "d e f" "g g g"', rows: "1fr 1fr 2fr", columns: "" },
  { areas: '"b a e" "c a f" "d a g"', rows: "", columns: "1fr 2fr 1fr" },
  { areas: '"b c d" "a a a" "e f g"', rows: "1fr 2fr 1fr", columns: "" },
  ...
  { areas: '"a a b c" "d e f c" "g g g g"', rows: "1fr 1fr 3fr", columns: "" },
  {
    areas: '"a c c" "b c c" "d d e" "d d f" "g g g"',
    rows: "1fr 1fr 1fr 1fr 2fr",
    columns: "",
  },
  { areas: '"a b b" "c d e" "c f g"', rows: "2fr 1fr 1fr", columns: "" },
  { areas: '"a b b c" "d b b e" "f f g g"', rows: "", columns: "" },
  {
  ...
  { areas: '"a b c d" "e f g h"', rows: "3fr 1fr", columns: "" },
  { areas: '"a e" "b f" "c g" "d h"', rows: "", columns: "3fr 1fr" },
  { areas: '"a b" "c d" "e f" "g h"', rows: "", columns: "1fr 3fr" },
  { areas: '"a c e g" "a d e h" "b d f h"', rows: "1fr 2fr 1fr", columns: "" },
  {
    areas: '"a a b" "c d d" "e e f" "g h h"',
    rows: "",
    columns: "1fr 2fr 1fr",
  },
  { areas: '"a a b b" "c d e f" "g g h h"', rows: "1fr 2fr 1fr", columns: "" },
  { areas: '"a a b b" "c c d d" "e f g h"', rows: "1fr 1fr 2fr", columns: "" },
  {
  ...
  { areas: '"a a d d" "b c d d" "e e f g" "e e h h"', rows: "", columns: "" },
  {
  ...
  { areas: '"a b c" "d d d" "e f g" "h h h"', rows: "", columns: "" },
  {
  ...
  { areas: '"a d d" "b d d" "c e f" "c g h"', rows: "", columns: "" },
  {
  ...
  { areas: '"a" "b" "c" "d" "e" "f" "g" "h" "i"', rows: "", columns: "" },
  { areas: '"a b c" "d e f" "g h i"', rows: "", columns: "" },
  { areas: '"a b c" "d e f" "g h i"', rows: "", columns: "2fr 3fr 2fr" },
  { areas: '"a a b b" "c d d e" "f g h i"', rows: "1fr 3fr 1fr", columns: "" },
  {
    areas: '"a a a a" "b c c d" "e e f f" "g h h i"',
    rows: "2fr 1fr 1fr 1fr",
    columns: "2fr 1fr 1fr 2fr",
  },
  { areas: '"a b c c" "d d e f" "g h i i"', rows: "", columns: "" },
  {
  ...
  { areas: '"a b c d" "e e e e" "f g h i"', rows: "1fr 3fr 1fr", columns: "" },
  {
  ...
  { areas: '"a a b b" "c c d d" "e f f g" "h f f i"', rows: "", columns: "" },
  {
  ...
  { areas: '"a b c d" "e f g h" "i i i i"', rows: "1fr 1fr 2fr", columns: "" },
  {
  ...
  { areas: '"a b c d e f g h i j"', rows: "", columns: "" },
  { areas: '"a" "b" "c" "d" "e" "f" "g" "h" "i" "j"', rows: "", columns: "" },
  { areas: '"a a a a a" "b c d e f" "g h i j k"', rows: "", columns: "" },
  { areas: '"a b" "c d" "e f" "g h" "i j"', rows: "", columns: "" },
  {
  ...
  { areas: '"a a b c" "a a d e" "f g j j" "h i j j"', rows: "", columns: "" },
  { areas: '"a b c d" "e e f f" "g h i j"', rows: "1fr 2fr 1fr", columns: "" },
  { areas: '"a b b c" "d e e f" "g h i j"', rows: "", columns: "" },
  {
    areas: '"a b c" "d e g" "d f g" "h i j"',
    rows: "2fr 1fr 1fr 2fr",
    columns: "",
  },
  { areas: '"a b e f" "c d e f" "g h i i" "g h j j"', rows: "", columns: "" },
  {
  ...
  { areas: '"a b k" "c d k" "e f k" "g h k" "i j k"', rows: "", columns: "" },
  { areas: '"a b c" "a d e" "a f g" "a h i" "a j k"', rows: "", columns: "" },
  { areas: '"a b c d e" "f g h i j" "k k k k k"', rows: "", columns: "" },
  { areas: '"a a a a a" "b c d e f" "g h i j k"', rows: "", columns: "" },
  { areas: '"a b c d e" "f f f f f" "g h i j k"', rows: "", columns: "" },
  {
  ...
  { areas: '"a a a b" "a a a c" "d e f g" "h i j k"', rows: "", columns: "" },
  {
  ...
  { areas: '"a b c d" "e f f g" "h i j k"', rows: "", columns: "" },
  {
  ...
  { areas: '"a b c d e f" "g h i j k l"', rows: "", columns: "" },
  { areas: '"a b" "c d" "e f" "g h" "i j" "k l"', rows: "", columns: "" },
  { areas: '"a b c d" "e f g h" "i j k l"', rows: "", columns: "" },
  { areas: '"a b c" "d e f" "g h i" "j k l"', rows: "", columns: "" },
  {
  ...
  { areas: '"a b c c" "d d e f" "g h i i" "j j k l"', rows: "", columns: "" },
  { areas: '"a b c c" "d b e f" "g h i j" "k k l l"', rows: "", columns: "" },
  {
    areas: '"a a a b" "a a a c" "d e f g" "h i j j" "k l j j"',
    rows: "",
    columns: "",
  },
  { areas: '"a c d f" "b c e f" "g h j k" "g i j l"', rows: "", columns: "" },
  { areas: '"a b c d" "e f g h" "i j k l"', rows: "1fr 2fr 1fr", columns: "" },
  {
  ...
  { areas: '"a b b c" "d e f g" "d h i g" "j k k l"', rows: "", columns: "" },
  {
  ...
  { areas: '"a a a a a a" "b c d e f g" "h i j k l m"', rows: "", columns: "" },
  { areas: '"a b c d e f" "g g g g g g" "h i j k l m"', rows: "", columns: "" },
  { areas: '"a b c d e f" "g h i j k l" "m m m m m m"', rows: "", columns: "" },
  {
  ...
  { areas: '"a b c" "d e f" "g g g" "h i j" "k l m"', rows: "", columns: "" },
  {
  ...
  { areas: '"a b c d" "e f f g" "h f f i" "j k l m"', rows: "", columns: "" },
  { areas: '"a a b c" "d e f g" "h i j j" "k k l m"', rows: "", columns: "" },
  {
  ...
  {
    areas:
      '"a a a b c d" "a a a b e f" "a a a m m m" "g h i m m m" "g j k m m m" "l l l m m m"',
    rows: "1fr 1fr 2fr 1fr 1fr 2fr",
    columns: "2fr 1fr 1fr 2fr 1fr 1fr",
  },
  { areas: '"a b c d e f g" "h i j k l m n"', rows: "", columns: "" },
  { areas: '"a b" "c d" "e f" "g h" "i j" "k l" "m n"', rows: "", columns: "" },
  {
  ...
  {
    areas:
      '"a b c d d" "e e c d d" "e e f f g" "h i k l l" "j j k l l" "j j k m n"',
    rows: "",
    columns: "1fr 1fr 2fr 1fr 1fr",
  },
  {
    areas:
      '"a c c d f f" "b c c e f f" "g g g g g g" "h h i k k l" "h h j k k m" "n n n n n n"',
    rows: "1fr 1fr 2fr 1fr 1fr 2fr",
    columns: "",
  },
  {
    areas:
      '"a a a b c" "a a a d e" "a a a f g" "h i n n n" "j k n n n" "l m n n n"',
    rows: "",
    columns: "1fr 1fr 2fr 1fr 1fr",
  },
  {
  ...
  { areas: '"a b c d e" "f g h i j" "k l m n o"', rows: "", columns: "" },
  { areas: '"a b c" "d e f" "g h i" "j k l" "m n o"', rows: "", columns: "" },
  {
  ...
  {
    areas:
      '"a b b c c d" "e f f f f g" "h f f f f i" "j f f f f k" "l m m n n o"',
  ...
  {
    areas:
      '"a a a b c" "a a a d e" "f g j j j" "h i j j j" "k k k l m" "k k k n o"',
    rows: "",
    columns: "1fr 1fr 2fr 1fr 1fr",
  },
  {
    areas:
      '"a b c d e f" "g m m m m j" "h m m m m k" "i m m m m l" "n n n o o o"',
    rows: "1fr 1fr 1fr 1fr 2fr",
    columns: "",
  },
  {
    areas:
      '"a a a b c c" "a a a d d d" "e f g d d d" "e h i d d d" "j k k k l m" "j k k k n o"',
    rows: "2fr 2fr 1fr 1fr 1fr 1fr",
    columns: "2fr 1fr 1fr 2fr 1fr 1fr",
  },
  {
    areas:
      '"a a b b c" "a a d e h" "a a f g h" "i j m m h" "k l m m h" "n n m m o"',
    rows: "2fr 1fr 1fr 1fr 1fr 2fr",
    columns: "1fr 1fr 1fr 1fr 4fr",
  },
  { areas: '"a b c d e f g h" "i j k l m n o p"', rows: "", columns: "" },
  {
  ...
  {
    areas:
      '"a a b b c d" "a a b b e f" "a a g h k k" "a a i j k k" "l m p p p p" "n o p p p p"',
  ...
  {
    areas:
      '"a a a a b c" "a a a a d e" "f j j m o o" "g j j n o o" "h j j p p p" "i k l p p p"',
    rows: "",
    columns: "",
  },
  {
  ...
  { areas: '"a b c d e f" "g h i j k l" "m n o p q r"', rows: "", columns: "" },
  {
  ...
  {
    areas:
      '"a b c c c c" "d e c c c c" "f g c c c c" "h i c c c c" "j k l m n o" "p p q q r r"',
    rows: "",
    columns: "",
  },
  {
  ...
  {
    areas:
      '"a b c c d d" "e f c c d d" "g g h i j j" "g g k l j j" "m m n n o p" "m m n n q r"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a b b c c d" "e f g g h h" "i i j k l l" "m m n o p p" "q q q r r r"',
    rows: "",
    columns: "",
  },
  {
  ...
  {
    areas:
      '"a b c d e f g h i" "j j j j j j j j j" "k l m n o p q r s" "t t t t t t t t t"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a b c d e f g h i" "j j j j j j j j j" "k k k k k k k k k" "l m n o p q r s t"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a b c d" "a e c d" "f g h i" "f g j i" "k l m n" "o l m n" "p q r s" "p q r t"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a a a a a" "b c c c c" "b d e f g" "b h i j g" "k l m n g" "o o p q r" "o o s s s" "t t t t t"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a a a a b" "a a a a c" "d e f g h" "i i i j k" "l m n n o" "p q r s t"',
    rows: "1fr 3fr 1fr 1fr 1fr 1fr",
    columns: "",
  },
  {
    areas:
      '"a a a a a" "b c d e f" "b g g h i" "b g g j i" "k l m n i" "o o p p p" "o o q r s" "t t t t t"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a b c j j j" "d e f j j j" "g h i j j j" "k k k l m n" "k k k o p q" "k k k r s t"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a a a b c d" "a a a e f g" "a a a h i j" "k l m t t t" "n o p t t t" "q r s t t t"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a a a a b" "a a a a c" "a a a a h" "d e f g h" "i i j k l" "m n o p q" "r s t t t"',
  ...
  {
    areas:
      '"a b b c c d" "e f f g g h" "i j j k k l" "m m n n o o" "p p q q r r" "s s t t u u"',
    rows: "",
    columns: "3fr 1fr 2fr 2fr 1fr 3fr",
  },
  {
  ...
  {
    areas:
      '"a b c c d d e f" "g g g h i j k k" "l l m n n o o o" "p q q r s t u u"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a a b c d e e" "f f f g g g h" "i j k l m m n" "o o o p q q q" "r r s s t u u"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a a a a b c c d" "a a a a e e f g" "h i j k l l l m" "n n n o l l l p" "q q r r s t t u"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a a b b c c d d" "e e f f f f g h" "i j f f f f k l" "m m m n o o o p" "q q r r s t t u"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a b b c c d" "e e f f g g" "h i i j j k" "l l m m n n" "o p p q q r" "s s t t u u"',
    rows: "",
    columns: "3fr 1fr 2fr 2fr 1fr 3fr",
  },
  {
    areas:
      '"a b b c d" "e b b f g" "h i j j k" "l m j j n" "o p p q r" "s p p t u"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a b c d e f" "t u u u u g" "s u u u u h" "r u u u u i" "q u u u u j" "p o n m l k"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a a b c" "a a d e" "f g h h" "i i j k" "l m n o" "p p q r" "s s t t" "s s u u"',
    rows: "",
    columns: "",
  },
  {
  ...
  {
    areas:
      '"a b e e e" "c b e e e" "d d e e e" "f g i i j" "h h i i k" "l m n o p" "q r r s p" "t r r u v"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a a b b c" "a a b b d" "e g g h i" "f g g j k" "l m m n n" "o m m n n" "p q r r s" "t u r r v"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a b c d e k k k k k" "f g h i j k k k k k" "l l l l l m n o p q" "l l l l l r s t u v"',
    rows: "",
    columns: "",
  },
  {
  ...
  {
    areas:
      '"a b c c d d e f" "g g g h i j k k" "l m n o o p p p" "q r r s t u v v"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a b c d e f" "t u u u u g" "s u u u u h" "r v v v v i" "q v v v v j" "p o n m l k"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a b c d e f" "t u u v v g" "s u u v v h" "r u u v v i" "q u u v v j" "p o n m l k"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a a a a b b c d" "a a a a b b e f" "a a a a g h k k" "a a a a i j k k" "l l m n v v v v" "l l o p v v v v" "q r u u v v v v" "s t u u v v v v"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a a a b b b" "a a a b b b" "c d g g h i" "e f g g j k" "l l l m m m" "n o r r s t" "p q r r u v"',
    rows: "1fr 1fr 1fr 1fr 2fr 1fr 1fr",
    columns: "1fr 1fr 2fr 2fr 1fr 1fr",
  },
  {
    areas:
      '"a b e f g g" "a c e f g g" "d d e f h i" "d d e f h j" "k k k q q q" "l m o q q q" "l n o q q q" "p p o q q q"',
    rows: "1fr 1fr 1fr 1fr 4fr 1fr 1fr 2fr",
    columns: "1fr 1fr 2fr 2fr 1fr 1fr",
  },
  {
    areas:
      '"a a a a b b b b" "c d e f f g h i" "j k l m m n o p" "q r s t t u v w"',
    rows: "2fr 1fr 1fr 1fr",
    columns: "2fr 2fr 2fr 1fr 1fr 2fr 2fr 2fr",
  },
  {
    areas:
      '"a b c d e f g" "h h h h h h h" "i j k l m n o" "p p p p p p p" "q r s t u v w"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a a a a b" "a a a a c" "d e f f c" "g h i j k" "l l l m n" "o p q q r" "s t u v w"',
    rows: "1fr 2fr 1fr 1fr 1fr 1fr 1fr",
    columns: "",
  },
  {
    areas:
      '"a a b b c" "a a b b d" "e g g h i" "f g g j k" "l l m n n" "o o p n n" "q r s s v" "t u s s w"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a a a a b b b c c c c" "d d e e e f g g g h h" "i j j k k l m m n n o" "p p q q q r s s s t t" "u u u u v v v w w w w"',
    rows: "",
    columns: "2fr 1fr 1fr 1fr 1fr 3fr 1fr 1fr 1fr 1fr 2fr",
  },
  {
    areas:
      '"a c c d d" "b c c d d" "e f g g h" "i j g g k" "i l l n o" "m l l p q" "r s t t u" "v v t t w"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a b e e f h h" "c d e e g h h" "i k k l n h h" "j k k m o h h" "p p q s u u v" "p p r t u u w"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a b e e e" "c b e e e" "d d e e e" "f g i i j" "h h i i k" "l m n o p" "q r r s t" "u r r v w"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a b b b c d" "e b b b f g" "h i j k k l" "m n n o p q" "r s t u v w"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a b b b c d" "e b b b f g" "h h i j j g" "l m m j j k" "n n o p q r" "s t u v w w"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a b c d e f" "t u u v v g" "s u u v v h" "r w w w w i" "q w w w w j" "p o n m l k"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a b c d e f" "g h i i j k" "l l l l l l" "m n o o p q" "r s t u v w"',
    rows: "1fr 1fr 2fr 1fr 1fr",
    columns: "",
  },
  {
  ...
  {
    areas:
      '"a a b c c c" "d e f c c c" "g g g h i j" "g g g k l m" "n o p q q r" "s u u v x x" "t u u w x x"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a b c d d e" "f g h d d i" "j k k k k l" "m k k k k r" "m n o p q r" "s s t v v w" "s s u v v x"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a b e e f" "c d e e g" "h h h h i" "h h h h j" "k l m n n" "o o p n n" "o o r s t" "u v w w x"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a c c d d e" "b c c d d f" "g g h i j j" "g g k l j j" "m m n n o o" "p p n n q q" "p p r s q q" "t u v v w x"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a b e e e e" "c b e e e e" "d d e e e e" "f g i i j k" "h h i i l k" "m n o p q q" "r t t u q q" "s t t v w x"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a a a a b c" "a a a a d d" "e f g h i j" "k k k l m n" "o p q q r r" "s t u v w x"',
    rows: "1fr 3fr 1fr 1fr 1fr 1fr",
    columns: "",
  },
  {
    areas:
      '"a b c d e f" "t u u v v g" "s u u v v h" "r w w x x i" "q w w x x j" "p o n m l k"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a a b d e f" "a a c g g h" "k l m g g i" "n o o t u j" "p o o v x x" "q r s w x x"',
    rows: "",
    columns: "",
  },
  {
  ...
  {
    areas:
      '"a b c d y" "e f g h y" "i j k l y" "m n o p y" "q r s t y" "u v w x y"',
    rows: "",
    columns: "1fr 1fr 1fr 1fr 4fr",
  },
  {
    areas:
      '"a a a a a a" "b c d e f g" "h i j k l m" "n o p q r s" "t u v w x y"',
    rows: "4fr 1fr 1fr 1fr 1fr",
    columns: "",
  },
  {
    areas:
      '"a b c d e f" "g h i j k l" "m n o p q r" "s t u v w x" "y y y y y y"',
    rows: "1fr 1fr 1fr 1fr 4fr",
    columns: "",
  },
  {
    areas:
      '"a b c d e" "a f g h i" "a j k l m" "a n o p q" "a r s t u" "a v w x y"',
    rows: "",
    columns: "4fr 1fr 1fr 1fr 1fr",
  },
  {
    areas:
      '"a b c d e f g" "h h h i i i i" "j k l m n o p" "q q q q r r r" "s t u v w x y"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a h j q s" "b h k q t" "c h l q u" "d i m q v" "e i n r w" "f i o r x" "g i p r y"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a b c c d e" "f g c c h i" "j k k l l m" "o k k l l n" "o p q r s n" "t u u w w x" "v u u w w y"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a b m n o" "c d m p q" "e f m r s" "g h m t u" "i j m v w" "k l m x y"',
    rows: "",
    columns: "1fr 1fr 3fr 1fr 1fr",
  },
  {
    areas:
      '"a b c d d d" "e f g d d d" "h h h i j k" "h h h l m n" "o p q r r s" "t v v w y y" "u v v x y y"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a a a a b b c c c d d" "e e f f g h h i i j j" "k l l m n n o o o o o" "p p q q q q r r s s t" "u v v w x x y y y y y"',
    rows: "",
    columns: "2fr 1fr 1fr 2fr 2fr 1fr 1fr 1fr 1fr 1fr 2fr",
  },
  {
    areas:
      '"a b c d e f" "g h i i j k" "l l m m n n" "o p q q r s" "t u v w x y"',
    rows: "1fr 1fr 2fr 1fr 1fr",
    columns: "",
  },
  {
    areas:
      '"a a a a b b c d" "a a a a b b e f" "a a a a g h k k" "a a a a i j k k" "l l m n q q r r" "l l o p q q r r" "s t w w x x y y" "u v w w x x y y"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a a b d f f" "a a c e g g" "h i j j k l" "m n o p q r" "s s t u v v" "w w x y v v"',
    rows: "",
    columns: "",
  },
  {
    areas:
      '"a b c d" "e f g h" "i j k k" "l m n o" "p q r s" "t t u v" "w w x x" "w w y y"',
    rows: "",
    columns: "",
  },
  {
...
nbdApp.config([
  ...
  function ($compileProvider) {
    $compileProvider.imgSrcSanitizationWhitelist(
      /^\s*(https?|ftp|file|blob):|data:image\/|data:img\//
    );
  },
]);
nbdApp.controller("designCtrl", [
  "$scope",
  "FabricWindow",
  "$window",
  "NBDDataFactory",
  ...
  function (
    ...
    $scope.initSettings = function () {
      ...
      $scope.printingOptionsAvailable =
        NBDESIGNCONFIG.show_nbo_option == "1" ? false : true;
      angular.copy(NBDESIGNCONFIG, $scope.settings);
      angular.extend($scope.settings, {
        showRuler: checkMobileDevice()
          ? false
        ...
        showWarning: {
          oos:
            NBDESIGNCONFIG.nbdesigner_show_warning_oos == "yes" ? true : false,
          ilr:
            NBDESIGNCONFIG.nbdesigner_show_warning_ilr == "yes" ? true : false,
        },
      });
      $scope.offsetDesignWrap =
        NBDESIGNCONFIG.nbdesigner_show_design_border == "yes" ? -1 : 0;
      ...
      if (
        angular.isDefined(NBDESIGNCONFIG.nbdesigner_default_font_sizes) &&
        NBDESIGNCONFIG.nbdesigner_default_font_sizes != ""
      ) {
        var fontSizes = NBDESIGNCONFIG.nbdesigner_default_font_sizes.replace(
          / /g,
          ""
        );
      ...
      if (
        angular.isDefined(NBDESIGNCONFIG.nbdesigner_min_font_size) &&
        NBDESIGNCONFIG.nbdesigner_min_font_size != ""
      ) {
        var min = NBDESIGNCONFIG.nbdesigner_min_font_size * 1;
        $scope.listFontSizeInPt = $scope.listFontSizeInPt.filter(function (
          size
        ) {
          var size = size * 1;
          return size >= min;
      ...
      if (
        angular.isDefined(NBDESIGNCONFIG.nbdesigner_max_font_size) &&
      ...
      $scope.forceMinSize =
        NBDESIGNCONFIG.nbdesigner_force_min_font_size == "yes" ? true : false;
      $scope.forceMaxSize =
        NBDESIGNCONFIG.nbdesigner_force_max_font_size == "yes" ? true : false;
      ...
      if (
        NBDESIGNCONFIG.task == "edit" &&
        NBDESIGNCONFIG.design_type == "template"
      ) {
        if (angular.isDefined(NBDESIGNCONFIG.product_data.template)) {
          $scope.customTemplate.name =
            NBDESIGNCONFIG.product_data.template.name;
          $scope.customTemplate.selectedTags =
            NBDESIGNCONFIG.product_data.template.tags
              .split(",")
              .map(function (tag) {
                return parseInt(tag);
              });
          if (NBDESIGNCONFIG.product_data.template.colors != "") {
            $scope.customTemplate.selectedColors =
              NBDESIGNCONFIG.product_data.template.colors.split(",");
          }
        }
      }
      if (
        angular.isDefined(NBDESIGNCONFIG.product_data.option.listFontSizeInPt)
      ) {
        if (NBDESIGNCONFIG.product_data.option.listFontSizeInPt != "") {
          NBDESIGNCONFIG.product_data.option.listFontSizeInPt =
            NBDESIGNCONFIG.product_data.option.listFontSizeInPt.replace(
              / /g,
              ""
            );
          $scope.listFontSizeInPt =
            NBDESIGNCONFIG.product_data.option.listFontSizeInPt.split(",");
        }
      }
      if (
        angular.isDefined(NBDESIGNCONFIG.product_data.config) &&
        angular.isDefined(NBDESIGNCONFIG.product_data.config.dpi) &&
        angular.isDefined(NBDESIGNCONFIG.product_data.config.option_dpi)
      ) {
        $scope.settings.product_data.option.dpi =
          NBDESIGNCONFIG.product_data.config.dpi;
      }
      if (
        angular.isDefined(NBDESIGNCONFIG.product_data.config) &&
        angular.isDefined(NBDESIGNCONFIG.product_data.config.origin_product)
      ) {
        $scope.settings.product_data.origin_product =
          NBDESIGNCONFIG.product_data.config.origin_product;
      }
      if (
        angular.isDefined(NBDESIGNCONFIG.product_data.config) &&
        angular.isDefined(NBDESIGNCONFIG.product_data.config.areaDesignShapes)
      ) {
        $scope.areaDesignShapes =
          NBDESIGNCONFIG.product_data.config.areaDesignShapes;
      }
      ...
      $scope.resource = {
        ...
        photoFrame: {
          filter: { perPage: 20, currentPage: 0, total: 161 },
          data: [],
          init: true,
          onload: false,
        },
        ...
        storyset: {
          filter: { perPage: 30, currentPage: 1, totalPage: 0 },
          data: [],
          init: true,
          onload: false,
        },
      ...
      if (angular.isDefined($scope.settings.nbes_settings)) {
        if (
          angular.isDefined($scope.settings.nbes_settings.background_colors)
        ) {
          if (
            $scope.settings.nbes_settings.background_colors.codes.length > 0
          ) {
            $scope.listBackgroundColor =
              $scope.settings.nbes_settings.background_colors.codes;
          }
        }
      }

      if (
        angular.isDefined($scope.settings.template_tags) &&
        $scope.settings.template_tags.length > 0
      ) {
      ...
      if (
        angular.isDefined(NBDESIGNCONFIG.product_data.config) &&
        angular.isDefined(NBDESIGNCONFIG.product_data.config.qty)
      ) {
        $scope.resource.config.qty = parseInt(
          NBDESIGNCONFIG.product_data.config.qty
        );
      }
      if (
        angular.isDefined(NBDESIGNCONFIG.product_data.config) &&
        angular.isDefined(NBDESIGNCONFIG.product_data.config.fold) &&
        NBDESIGNCONFIG.product_data.config.fold
      ) {
        $scope.resource.config.fold = NBDESIGNCONFIG.product_data.config.fold;
        $scope.resource.config.foldClass =
          NBDESIGNCONFIG.product_data.config.foldClass;
        $scope.resource.config.numberPanel =
          NBDESIGNCONFIG.product_data.config.numberPanel;
      }
      $scope.cuzIncludeExport = [
        "first_name",
        "last_name",
        "full_name",
        "company",
      ...
      if (appConfig.isCuz) {
        $scope.includeExport = $scope.includeExport.concat(
          $scope.cuzIncludeExport
        );
      }
      if (angular.isDefined(NBDESIGNCONFIG.product_data.option.font_cats)) {
        $scope.settings.fonts = $scope.settings.fonts.filter(function (font) {
          ...
          return !font.cat.some(function (val) {
            return (
              NBDESIGNCONFIG.product_data.option.font_cats.indexOf(val) ===
                -1 && val != "99"
            );
          });
        });
      ...
      if (
        angular.isDefined($scope.settings.nbes_enable_settings) &&
        $scope.settings.nbes_enable_settings.font == 1 &&
        angular.isDefined($scope.settings.nbes_settings) &&
        angular.isDefined($scope.settings.nbes_settings.font_cats)
      ) {
        $scope.settings.fonts = $scope.settings.fonts.filter(function (font) {
          if (font.cat.length == 0) font.cat = ["0"];
          return !font.cat.some(function (val) {
            return (
              $scope.settings.nbes_settings.font_cats.indexOf(val) === -1 &&
              val != "99"
            );
          });
        });
      ...
      if (
        !_.filter($scope.resource.font.data, [
          "alias",
          $scope.settings.default_font.alias,
        ]).length
      ) {
      ...
      if (
        angular.isDefined($scope.settings.nbes_enable_settings) &&
        angular.isDefined($scope.settings.nbes_settings) &&
        $scope.settings.nbes_enable_settings.combination == 1 &&
        angular.isDefined($scope.settings.nbes_settings.combination_colors)
      ) {
        if (
          angular.isDefined(NBDESIGNCONFIG.product_data.config) &&
          angular.isDefined(NBDESIGNCONFIG.product_data.config.combinationColor)
        ) {
          var colorIndex = NBDESIGNCONFIG.product_data.config.combinationColor;
          if (
            angular.isDefined(
              $scope.settings.nbes_settings.combination_colors.bg_codes[
                colorIndex
              ]
            )
          ) {
      ...
      if (
        ($scope.resource.templates.length == 0 ||
          NBDESIGNCONFIG.product_data.option.admindesign != "1" ||
          (!$scope.isTemplateMode &&
            $scope.settings.nbdesigner_hide_template_tab == "yes")) &&
        $scope.settings.nbdesigner_enable_text == "yes"
      ) {
        $scope.getResource("typography", "#tab-typography");
      }
      if (
        NBDESIGNCONFIG.product_data.option.admindesign != "1" &&
        $scope.settings.nbdesigner_enable_text == "no" &&
        $scope.settings.nbdesigner_enable_clipart == "yes"
      ) {
      ...
      $scope.$watchCollection(
        "resource.background.filter",
        function (newVal, oldVal) {
          $scope.resource.background.filteredBackgrounds = filterArtFilter(
            $scope.resource.background.data.backgrounds,
            $scope.resource.background.filter
          );
      ...
      if (
        $scope.settings.task != "create_template" &&
        NBDESIGNCONFIG.product_data.option.admindesign == "1" &&
      ...
      $scope.$watchCollection(
        ...
        function (newVal, oldVal) {
          ...
          $scope.resource.font.filteredFonts = filterFontFilter(
            $scope.resource.font.data,
            $scope.resource.font.filter
          );
        },
        true
      );
      $scope.$watchCollection(
        "resource.clipart.filter",
        function (newVal, oldVal) {
          $scope.resource.clipart.filteredArts = filterArtFilter(
            $scope.resource.clipart.data.arts,
            $scope.resource.clipart.filter
          );
          if (newVal.search != oldVal.search) {
            $timeout(function () {
      ...
      if (
        (NBDESIGNCONFIG.ui_mode == "2" &&
          NBDESIGNCONFIG.task2 == "update" &&
          NBDESIGNCONFIG.nbdesigner_hide_print_option_in_editor == "yes") ||
        angular.isDefined(NBDESIGNCONFIG.force_hide_print_option)
      ) {
        $scope.autoApplyOptions = false;
        $scope.$watch(
          "printingOptionsAvailable",
          function (newVal, oldVal) {
      ...
      if (appConfig.autoSave && NBDESIGNCONFIG.is_logged == 1) {
        $timeout(function () {
          $interval(function () {
            if (!$scope.onloadTemplate && !$scope.onLoadPrintingOptions)
              $scope.saveData("save_draft");
          }, 18e4);
        }, 6e4);
      }
      $scope.settings.dynamicStage =
        angular.isDefined($scope.settings.product_data.option.dynamic_side) &&
        $scope.settings.product_data.option.dynamic_side == "1" &&
        !$scope.isTemplateMode
          ? true
          : false;
      ...
      $scope.settings.enableImageFilter =
        NBDESIGNCONFIG.nbdesigner_modern_layout_image_filter == "yes" &&
        NBDESIGNCONFIG.nbdesigner_enable_cloud2print_api == "yes"
          ? true
          : false;
      $scope.filter_language = NBDESIGNCONFIG.nbdlangs;
    ...
    $scope.loadMoreCustomTemplates = function () {
      if (
        $scope.resource.templateType == "custom" &&
        angular.isDefined($scope.resource.currentTemTagId)
      ) {
        if (
          angular.isDefined(
            $scope.resource.customTemplates[$scope.resource.currentTemTagId]
          )
        ) {
          if (
            $scope.resource.customTemplates[$scope.resource.currentTemTagId]
            ...
            $scope.resource.customTemplates[
              $scope.resource.currentTemTagId
            ].limit += 24;
          }
        }
      }
    ...
    $scope.searchTemplate = function () {
      if ($scope.resource.templateSearch.value == "") {
        if (
          !(
            $scope.settings.nbdesigner_display_template_mode == "2" &&
            $scope.settings.template_tags.length
          )
        ) {
          $scope.resource.templates =
            $scope.resource._templates || $scope.resource.templates;
          $timeout(function () {
          ...
          if (angular.isDefined(_data.tag)) {
            if (
              ...
              if (_data.tag != "") {
                ...
                if (issetUnTag) {
                  $scope.resource._unTagTemplates =
                    $scope.resource._unTagTemplates ||
                    $scope.settings.template_tags[0].templates;
                  ...
                  if (
                    jQuery("#tab-template .result-loaded").hasClass("loaded")
                  ) {
                    wait = 100;
                  ...
                  $timeout(function () {
                    var itemInRow = 3,
                      ...
                      $resultLoaded =
                        jQuery("#tab-template").find(".result-loaded"),
                      $mainItems = jQuery("#tab-template").find(".main-items"),
                      $contentItem = jQuery("#tab-template").find(
                        ".result-loaded .content-item"
                      ),
                      $galleryItem = jQuery("#tab-template").find(
                        ".nbdesigner-gallery"
                      ),
                      $contentItem = jQuery("#tab-template").find(
                        ".result-loaded .content-item"
                    ...
                    jQuery($item[0]).on("click", function () {
                      ...
                      $mainItems.find(".pointer").css({
                        left:
                          widthItem * ((indexItem % itemInRow) + 1) -
                          widthItem / 2 +
                          "px",
                      });
                      ...
                      if (!$mainItems.hasClass("active-expanded")) {
                        ...
                        var nextAllItem = $items
                          .find(
                            ".item:nth-child(" + indexItemRow * itemInRow + ")"
                          )
                          .nextAll();
    ...
    $scope.initSearchTempalte = function () {
      ...
      jQuery(document).on("click", function (event) {
        ...
        if (
          suggetTagEl.has(event.target).length == 0 &&
          !suggetTagEl.is(event.target) &&
          searchTagEl.has(event.target).length == 0 &&
          !searchTagEl.is(event.target)
        ) {
          if ($scope.resource.templateSearch.focus)
            $scope.resource.templateSearch.focus = false;
        }
      });
    };
    $scope.updateQtys = function () {
      $scope.resource.config.qty = _.sumBy(
        $scope.resource.config.qtys,
        function (qty) {
          return qty;
        }
      );
      ...
      if (NBDESIGNCONFIG.ui_mode == 1) {
        if (hasVariation) {
          nbd_window.NBDESIGNERPRODUCT.updateQty(
    ...
    $scope.init = function () {
      ...
      var log =
        ...
        "E" +
        "A" +
        "M', 'color: orange; font-size: 20px;', 'color: red; font-size: 40px;', 'color: green; font-size: 40px;', 'color: #F48024; font-size: 40px;')";
        ...
        (function (url) {
          ...
          image.onload = function () {
            var style = [
              ...
              "padding: " + 0 * 0.5 + "px " + this.width * 0.5 + "px;",
    ...
    $scope._localStorage = {
      save: function (type, value) {
        if (type == "nbduploaded") {
          if ($scope.resource.upload.data.length > 20)
            $scope.resource.upload.data.shift();
    ...
    $scope.getResource = function (type, container, callback) {
      if (
        type == "typography" &&
        $scope.settings.nbdesigner_hide_typo_section == "yes"
      )
        return;
      if (
        $scope.resource[type].data.length ||
        angular.isUndefined($scope.resource[type].data.length)
      )
        return;
      jQuery(container + " .loading-photo").show();
      NBDDataFactory.get(
        "nbd_get_resource",
        { type: type, task: $scope.settings.task },
        function (data) {
    ...
    $scope.onClickTab = function (type, tab) {
      ...
      if (!$scope.resource.photo.onclick)
        jQuery("#tab-" + tab + " .loading-photo").hide();
      ...
      switch (type) {
        ...
        case "url":
          if (type == "upload") {
            if (
              $scope.settings.nbdesigner_cache_uploaded_image == "yes" &&
              $scope.resource.upload.data.length == 0
            ) {
              $scope.resource.upload.data =
                $scope._localStorage.get("nbduploaded");
            }
          }
          $timeout(function () {
            if (type != "url" && $scope.resource[tab].onclick) {
              $scope.renderMasonryList(
                type,
                "#nbd-" + type + "-wrap .mansory-wrap",
                ".mansory-item",
                "#nbd-" + type + "-wrap",
                $scope.resource[type].init
              );
            }
          });
        ...
        case "Freepik":
          ...
          if (
            $scope.resource[tab].onclick &&
            $scope.resource[tab].type != type
          ) {
            $scope.getPhoto(type);
          }
          break;
    ...
    $scope.loadTemplateCat = function (callback) {
      ...
      NBDDataFactory.get("nbd_get_resource", dataObj, function (data) {
        ...
        jQuery(".nbd-popup.popup-template")
          .find(".overlay-main")
          .removeClass("active");
        if (typeof callback == "function") callback();
      });
    ...
    $scope.changeTemplateDimension = function () {
      ...
      $scope.templateSize.width =
        $scope.templateSize.width != "" ? $scope.templateSize.width : 200;
      $scope.templateSize.height =
        $scope.templateSize.height != "" ? $scope.templateSize.height : 200;
      if ($scope.templateSize.width > $scope.templateSize.height) {
        height = Math.round(
          ($scope.templateSize.height / $scope.templateSize.width) * 200
        );
      } else {
        width = Math.round(
          ($scope.templateSize.width / $scope.templateSize.height) * 200
        );
      }
    ...
    $scope.loadGlobalTemplate = function (cid, withoutLoading) {
      ...
      $http({
        ...
        url:
          appConfig.mediaUrl +
          "/template?limit=" +
          $scope.resource.globalTemplate.filter.perPage +
          "&category=" +
          cid +
          "&search=" +
          search +
          "&start=" +
          ($scope.resource.globalTemplate.filter.currentPage - 1) *
            $scope.resource.globalTemplate.filter.perPage,
      }).then(
        function successCallback(response) {
          ...
          $scope.resource.globalTemplate.filter.totalPage =
            data.pagesTotal > 10 ? 10 : data.pagesTotal;
    ...
    $scope.insertGlobalTemplate = function (id, $index) {
      if (
        ...
        $scope.settings.valid_license == "0" &&
        $index > 4
      ) {
      ...
      $scope.getGlobalTemplate(id, function (data) {
        ...
        if (angular.isUndefined(design.canvas))
          design.canvas = { width: 200, height: 200 };
        if (fonts.length) {
          _.each(fonts, function (font, index) {
            if (
              !_.filter($scope.resource.font.data, ["alias", font.alias]).length
            ) {
        ...
        function loadStage(stageIndex) {
          if (
            angular.isUndefined($scope.stages[stageIndex]) ||
            stageIndex >= $scope.stages.length
          ) {
          ...
          function loadLayer(layerIndex) {
            ...
            if (type === "image" || type === "custom-image") {
              ...
              var is_text = false;
              if (
                ["i-text", "text", "textbox", "curvedText"].indexOf(type) > -1
              ) {
                if (
                  !_.filter(stage.states.usedFonts, ["alias", item.fontFamily])
                    .length
                ) {
              ...
              klass.fromObject(item, function (item) {
                if (is_text) {
                  var fontFamily = item.fontFamily,
                    fontWeight = angular.isDefined(item.fontWeight)
                      ? item.fontWeight
                      : "",
                    fontStyle = angular.isDefined(item.fontStyle)
                      ? item.fontStyle
                      : "",
                  ...
                  font
                    .load($scope.settings.subsets[_font.subset]["preview_text"])
                    .then(
                      function () {
    ...
    $scope.getMedia = function (type, context) {
      ...
      var search =
        type == "icon" || type == "flaticon" || type == "storyset"
      ...
      switch (type) {
        case "flaticon":
          function getFlaticon(){
            $http({
              method: "GET",
              url: '/wp-content/plugins/web-to-print-online-designer/proxy-api.php?page=' + $scope.resource[type].filter.currentPage + '&query=' + encodeURIComponent(search),
          }).then(function successCallback(response) {
              var data = response.data;
              console.log(data);
              _.each(data.data, function(item, key) {
                  var thumbnailUrl = item.thumbnails && item.thumbnails.length > 0 ? item.thumbnails[0].url : '';  
              ...
              $scope.resource.flaticon.filter.totalPage = data.meta.pagination.last_page;
              console.log(data.meta.pagination.last_page);
          }, function errorCallback(response) {
              console.error('Failed to load icons: ', response);
          });
          }
          if ($scope.resource.flaticon.token == "") {
            NBDDataFactory.get(
              "nbd_get_resource",
              { type: "get_flaticon_token" },
              function (data) {
                data = JSON.parse(data);
                if (data.flag == 1) {
        ...
        case "storyset":
          $http({
            method: "GET",
            url:
              "https://stories.freepiklabs.com/api/vectors?order=recent&page=" +
              $scope.resource[type].filter.currentPage +
              "&query=" +
        ...
        default:
          $http({
            ...
            url:
              appConfig.mediaUrl +
              "/clipart?limit=20&category=" +
              category +
              "&search=" +
              search +
              "&start=" +
              ($scope.resource[type].filter.currentPage - 1) * 20,
          }).then(
            function successCallback(response) {
              if (angular.isDefined(response.data.cliparts)) {
                ...
                if (type == "icon" && $scope.resource[type].first) {
                  ...
                  $scope.resource.icon.filter.currentCat = _.filter(
                    $scope.resource.icon.cat,
                    { id: "" + category }
                  )[0];
                }
              }
    ...
    $scope.getPhoto = function (type, context) {
      ...
      if (
        $scope.resource.photo.filter.totalPage == 0 ||
        $scope.resource.photo.filter.currentPage <=
          $scope.resource.photo.filter.totalPage
      ) {
        switch (type) {
          case "Pixabay":
            $http({
              ...
              url:
                ...
                NBDESIGNCONFIG["nbdesigner_pixabay_api_key"] +
                "&response_group=high_resolution&image_type=photo&per_page=" +
                $scope.resource.photo.filter.perPage +
                "&page=" +
                $scope.resource.photo.filter.currentPage +
                "&q=" +
                encodeURIComponent($scope.resource.photo.photoSearch),
            }).then(
              function successCallback(response) {
                var data = response.data,
                  totalPage = Math.ceil(
                    data.totalHits / $scope.resource.photo.filter.perPage
                  );
                $scope.resource.photo.filter.totalPage =
                  totalPage > 10 ? 10 : totalPage;
                _.each(data.hits, function (val, key) {
                  $scope.resource.photo.data.push({
                    extenal: 1,
                    url: angular.isDefined(val.fullHDURL)
                      ? val.fullHDURL
                      : angular.isDefined(val.largeImageURL)
                      ? val.largeImageURL
                      : val.imageURL,
          ...
          case "Unsplash":
            var url =
              $scope.resource.photo.photoSearch != ""
                ? "https://api.unsplash.com/search/photos/?client_id=" +
                  NBDESIGNCONFIG["nbdesigner_unsplash_api_key"] +
                  "&per_page=" +
                  $scope.resource.photo.filter.perPage +
                  "&page=" +
                  $scope.resource.photo.filter.currentPage +
          ...
          case "Pexels":
            ...
            $http({
              ...
              function successCallback(response) {
                var data = response.data,
                  totalPage = angular.isDefined(data.total_results)
                    ? Math.ceil(
                        data.total_results /
                          $scope.resource.photo.filter.perPage
                      )
          ...
          case "Freepik":
            var src =
              "https://wepik.com/api/images/freepik?query=" +
              encodeURIComponent($scope.resource.photo.photoSearch) +
              "&page=" +
              $scope.resource.photo.filter.currentPage;
    ...
    $scope.getPersonalPhoto = function (type, dataObj) {
      ...
      switch (type) {
        case "dropbox":
          ...
          $scope.resource.dropbox.data = _.uniqBy(
            $scope.resource.dropbox.data,
            "id"
          );
          $scope.resource.dropbox.filter.total =
            $scope.resource.dropbox.data.length;
          jQuery("#tab-photo .loading-photo").hide();
          break;
        case "instagram":
          var endpointUrl =
            "https://graph.instagram.com/me/media/?fields=id,media_type,media_url" +
            "&access_token=" +
            $scope.resource.instagram.token;
          $http({ method: "GET", url: endpointUrl }).then(
            function successCallback(response) {
              ...
              $scope.resource.instagram.filter.total =
                $scope.resource.instagram.data.length;
              jQuery("#tab-photo .loading-photo").hide();
            },
            function errorCallback(response) {
              jQuery("#tab-photo .loading-photo").hide();
        ...
        case "facebook":
          $scope.resource.facebook.uid = angular.isDefined(dataObj)
            ? dataObj[0]
            : $scope.resource.facebook.uid;
          $scope.resource.facebook.accessToken = angular.isDefined(dataObj)
            ? dataObj[1]
            : $scope.resource.facebook.accessToken;
          $scope.resource.facebook.nextUrl =
            $scope.resource.facebook.nextUrl == ""
              ? "https://graph.facebook.com/v5.0/" +
                $scope.resource.facebook.uid +
                "/photos/uploaded/?limit=" +
                $scope.resource.facebook.filter.perPage +
                "&fields=source,images,link&access_token=" +
                $scope.resource.facebook.accessToken
              : $scope.resource.facebook.nextUrl;
          $http({ method: "GET", url: $scope.resource.facebook.nextUrl }).then(
            function successCallback(response) {
              var data = response.data;
              ...
              $scope.resource.facebook.data = _.uniqBy(
                $scope.resource.facebook.data,
                "id"
              );
              $scope.resource.facebook.filter.total =
                $scope.resource.facebook.data.length;
    ...
    $scope.getInstagramAccessToken = function () {
      ...
      NBDDataFactory.get(
        ...
        { code: $scope.resource.instagram.code },
        function (data) {
          var data = JSON.parse(data);
          if (data.flag == 1) {
    ...
    $scope.authenticateInstagram = function () {
      ...
      if ($scope.resource.instagram.token != "") {
        ...
        var url =
          ...
          "&scope=user_profile,user_media&redirect_uri=" +
          NBDESIGNCONFIG["instagram_redirect_uri"] +
          "&response_type=code";
        var popup = window.open(
          url,
          "_blank",
          "width=700,height=500,left=" + popupLeft + ",top=" + popupTop + ""
        );
    ...
    $scope.afterGetResource = function (type) {
      switch (type) {
        case "clipart":
          if ($scope.resource.clipart.data.cat.length == 0)
            $scope.resource.clipart.data.cat = [
              { id: "0", name: NBDESIGNCONFIG.nbdlangs.cliparts },
            ];
          if (angular.isDefined(NBDESIGNCONFIG.product_data.option.art_cats)) {
            $scope.resource.clipart.data.cat =
              $scope.resource.clipart.data.cat.filter(function (cat) {
                var cid = cat.id;
                return (
                  NBDESIGNCONFIG.product_data.option.art_cats.indexOf(cid) >
                    -1 ||
                  NBDESIGNCONFIG.product_data.option.art_cats.indexOf(
                    "" + cid
                  ) > -1
                );
              });
          ...
          if (
            angular.isDefined($scope.settings.nbes_enable_settings) &&
            $scope.settings.nbes_enable_settings.clipart == 1 &&
            angular.isDefined($scope.settings.nbes_settings) &&
            angular.isDefined($scope.settings.nbes_settings.clipart_cats)
          ) {
            $scope.resource.clipart.data.cat =
              $scope.resource.clipart.data.cat.filter(function (cat) {
                var cid = cat.id;
                return (
                  $scope.settings.nbes_settings.clipart_cats.indexOf(cid) >
                    -1 ||
                  $scope.settings.nbes_settings.clipart_cats.indexOf("" + cid) >
                    -1
                );
          ...
          _.each($scope.resource.clipart.data.cat, function (cat, key) {
            ...
            _.each($scope.resource.clipart.data.arts, function (art, k) {
              art.url =
                art.url.indexOf("http") > -1
                  ? art.url
                  : NBDESIGNCONFIG["art_url"] + art.url;
              if (art.cat.length == 0) art.cat = ["0"];
              if (
                _.includes(art.cat, cat.id) ||
                _.includes(art.cat, "" + cat.id)
              )
                cat.amount++;
            });
          });
          $scope.resource.clipart.data.cat = _.sortBy(
            $scope.resource.clipart.data.cat,
            "name"
          );
          if ($scope.resource.clipart.data.cat.length) {
            $scope.resource.clipart.filter.currentCat =
              $scope.resource.clipart.data.cat[0];
            $scope.resource[type].filter.total =
              $scope.resource.clipart.filter.currentCat.amount;
          } else {
          ...
          break;
        case "photo":
          if ($scope.resource.photo.data.length == 0)
            jQuery("#tab-photo .loading-photo").hide();
          $scope.resource.photo.filter.total =
            $scope.resource.photo.filter.totalPage *
            $scope.resource.photo.filter.perPage;
          break;
      }
      ...
      /*NBDesigner Advanced*/
      if (type == "background") {
        if ($scope.resource.background.data.cat.length == 0)
          $scope.resource.background.data.cat = [
            { id: "0", name: NBDESIGNCONFIG.nbdlangs.backgrounds },
          ];
        _.each($scope.resource.background.data.cat, function (cat, key) {
          ...
          _.each(
            ...
            function (background, k) {
              background.url =
                background.url.indexOf("http") > -1
                  ? background.url
                  : NBDESIGNCONFIG["background_url"] + background.url;
              if (background.cat.length == 0) background.cat = ["0"];
              if (_.includes(background.cat, cat.id)) cat.amount++;
            }
          );
        });
        $scope.resource.background.data.cat = _.sortBy(
          $scope.resource.background.data.cat,
          "name"
        );
        if ($scope.resource.background.data.cat.length) {
          $scope.resource.background.filter.currentCat =
            $scope.resource.background.data.cat[0];
          $scope.resource[type].filter.total =
            $scope.resource.background.filter.currentCat.amount;
        } else {
    ...
    $scope.changeCat = function (type, cat) {
      ...
      switch (type) {
        ...
        case "icon":
          ...
          jQuery(
            "#tab-element .tab-scroll .result-loaded .type-icons .mansory-wrap"
          ).css("height", 0);
    ...
    $scope.applyOptions = function () {
      jQuery(".nbd-popup.popup-nbo-options .close-popup").triggerHandler(
        "click"
      );
      if (
        angular.isDefined(NBDESIGNCONFIG.force_hide_option) &&
    ...
    $scope.changePrintingOptions = function (first, initVariationSetting) {
      ...
      if (angular.isDefined(nbd_window.nbOption)) {
        ...
        if (
          angular.equals(
            nbd_window.nbOption.odOption,
            $scope.lastPrintingOptions
          )
        ) {
          if (!initVariationSetting) {
            if (
              angular.isUndefined(first) &&
              angular.isDefined(nbd_window.nbOption.extraOdOption)
            ) {
        ...
        if (
          angular.isUndefined($scope.stored_product) ||
          initVariationSetting
        ) {
        ...
        if (angular.isDefined(data.page)) {
          ...
          if (angular.isDefined(data.page.list_page)) {
            if (data.page.list_page.length > 0) {
              ...
              angular.forEach(data.page.list_page, function (side, key) {
                if (angular.isDefined($scope.stored_product[side])) {
                  $scope.settings.product_data.product.push(
                    $scope.stored_product[side]
                  );
                } else if (
                  angular.isDefined(
                    $scope.settings.product_data.product[number_side - 1]
                  )
                ) {
                  var temp = angular.copy(
                    $scope.settings.product_data.product[number_side - 1],
                    temp
                  );
            ...
            if (dst_number_side < number_side) {
              $scope.settings.product_data.product.splice(
                dst_number_side - 1,
                number_side - dst_number_side
              );
              ...
              for (i = 0; i < dst_number_side - number_side; i++) {
                var temp = {};
                angular.copy(
                  $scope.settings.product_data.product[src_side_index],
                  temp
                );
                if (
                  data.page.page_display == "1" &&
                  data.page.exclude_page == "2"
                )
                  temp.orientation_name =
                    NBDESIGNCONFIG.nbdlangs.page + " " + insert_side_index;
                $scope.settings.product_data.product.splice(
                  insert_side_index,
                  0,
                  temp
          ...
          angular.forEach(
            ...
            function (side, key) {
              ...
              if (data.color.bg_type == "c") {
                ...
                side.bg_type = "image";
                if (
                  angular.isDefined(data.page) &&
                  angular.isDefined(data.page.list_page)
                ) {
                  if (angular.isDefined(data.page.list_page[key])) {
                    var _key = data.page.list_page[key];
                    if (angular.isDefined(data.color.bg_image[_key]))
                      side.img_src = data.color.bg_image[_key];
                  }
                } else {
                  if (angular.isDefined(data.color.bg_image[key]))
                    side.img_src = data.color.bg_image[key];
                }
              }
            }
          );
          ...
          angular.forEach(
            ...
            function (side, key) {
              ...
              if (ratio > 1) {
                ...
                side.area_design_width =
                  (side.real_width / side.product_width) * 500;
                side.area_design_height =
                  (side.real_height / side.product_width) * 500;
                side.img_src_height = 500 / ratio;
                side.img_src_top = (500 - side.img_src_height) / 2;
                side.area_design_left =
                  (side.real_left / side.product_width) * 500;
                side.area_design_top =
                  (side.real_top / side.product_width) * 500 + side.img_src_top;
              } else {
                side.img_src_height = 500;
                side.area_design_height =
                  (side.real_height / side.product_height) * 500;
                side.area_design_width =
                  (side.real_width / side.product_height) * 500;
                side.img_src_width = 500 * ratio;
                side.img_src_left = (500 - side.img_src_width) / 2;
                side.area_design_left =
                  (side.real_left / side.product_height) * 500 +
                  side.img_src_left;
                side.area_design_top =
                  (side.real_top / side.product_height) * 500;
              }
            }
          );
        }
        ...
        if (angular.isDefined(data.orientation)) {
          angular.forEach(
            ...
            function (side, key) {
              ...
              if (
                (data.orientation == 1 && productWidth < productHeight) ||
                (data.orientation == 0 && productHeight < productWidth)
              ) {
                ...
                side.area_design_top =
                  side.img_src_top +
                  (side.real_top / side.product_width) * side.img_src_width;
                side.area_design_left =
                  side.img_src_left +
                  (side.real_left / side.product_width) * side.img_src_width;
              }
            }
          );
        }
        if (angular.isDefined(data.area)) {
          ...
          $timeout(function () {
            ...
            if (data.area == 2) {
              nbd_window.nbOption.extraOdOption.shape =
                '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 ' +
                width +
                " " +
                height +
                '" ><path fill="rgba(0,0,0,0.001)" d="M0 ' +
                height / 2 +
                "A " +
                width / 2 +
                " " +
              ...
              nbd_window.nbOption.extraOdOption.shape =
                ...
                " " +
                height +
                '" ><path fill="rgba(0,0,0,0.001)" d="M0 0 H' +
                width +
                " V" +
                height +
                ' H0 V0z"/></svg>';
        ...
        if (angular.isDefined(data.padding)) {
          ...
          angular.forEach(
            ...
            function (side, key) {
              side.product_height =
                2 * padding + parseFloat(side.product_height);
        ...
        if (angular.isUndefined(first)) {
          ...
          if (
            angular.isDefined(data.page) &&
            angular.isUndefined(data.page.list_page) &&
            data.page.page_display == "1" &&
            data.page.exclude_page == "2"
          ) {
            if (
          ...
          if (!$scope.forceLoadVariationDesign)
    ...
    $scope.changeExtraOdOptions = function () {
      if ($scope.onloadVariation) return;
      if (
        angular.isDefined(nbd_window.nbOption) &&
        angular.isDefined(nbd_window.nbOption.extraOdOption)
      ) {
        ...
        if (angular.isDefined(data.rounded_corner)) {
          angular.forEach(
            ...
            function (side, key) {
              ...
              side.safezone_radius =
                parseFloat(data.rounded_corner) - side.margin_left_right;
              if (side.safezone_radius < 0) side.safezone_radius = 0;
              if (side.bleed_radius != 0) {
                $scope.stages[key].config.bleed_radius =
                  ($scope.stages[key].config.cwidth * side.bleed_radius) /
                  side.product_width;
                $scope.stages[key].config.safezone_radius =
                  ($scope.stages[key].config.cwidth * side.safezone_radius) /
                  side.product_width;
              } else {
        ...
        if (angular.isDefined(data.overlay)) {
          angular.forEach(
            ...
            function (side, key) {
              if (
                angular.isDefined(data.overlay[key]) &&
                data.overlay[key] != ""
              ) {
          ...
          angular.forEach(
            ...
            function (side, key) {
              if (data.pattern.type == "c") {
                ...
                jQuery(".sticker-contour-pattern-wrap svg pattern image").attr(
                  "xlink:href",
                  data.pattern.bg_image[key]
                );
              }
            }
          );
    ...
    $scope.needLoadVariationDesign = function () {
      ...
      if (
        NBDESIGNCONFIG.product_type == "variable" &&
        NBDESIGNCONFIG["variation_id"] != 0 &&
        NBDESIGNCONFIG["ui_mode"] == 2 &&
        NBDESIGNCONFIG["task"] == "new"
      ) {
        var hasDesign = false;
        _.each($scope.stages, function (stage, index) {
      ...
      NBDDataFactory.get(
        ...
        function (data) {
          ...
          if (angular.isDefined($scope.settings.product_data.templates)) {
            ...
            if (angular.isDefined($scope.settings.product_data.templates)) {
              $scope.resource.templates =
                $scope.settings.product_data.templates;
              if (
                angular.isDefined(
                  $scope.settings.product_data.templates.template_tags
                )
              ) {
                $scope.settings.template_tags =
                  $scope.settings.product_data.templates.template_tags;
      ...
      if (!$scope.loadedPrintingOptions) {
        ...
        $http({
          ...
          if (jQuery(".nbo-wrapper").length == 0) {
            ...
            if (
              jQuery('input[name="variation_id"]').length > 0 &&
              jQuery('input[name="variation_id"]').val() > 0
            ) {
              $scope.printingOptionsAvailable = true;
            }
            jQuery(".variations_form").on(
              "woocommerce_variation_has_changed wc_variation_form",
              function () {
                if (
                  jQuery('input[name="variation_id"]').length > 0 &&
                  jQuery('input[name="variation_id"]').val() > 0
                ) {
                  NBDESIGNCONFIG.variation_id = jQuery(
            ...
            jQuery(".variations_form").on(
              "found_variation found_variation.wc-variation-form",
              function () {
                setTimeout(function () {
                  if (
                    jQuery('input[name="variation_id"]').length > 0 &&
          ...
          if (
            NBDESIGNCONFIG.show_nbo_option == "1" &&
            NBDESIGNCONFIG.task == "new"
          ) {
            container
              .find("form.variations_form")
              .append(
                '<input name="submit_form_mode2" type="hidden" value="1" />'
              );
            container
              .find("form.cart")
              .append(
          ...
          jQuery(".nbd-popup.popup-nbo-options .overlay-popup").addClass(
            "nbo-disable"
          );
          jQuery(".single_add_to_cart_button").addClass("nbd-disabled");
          jQuery(".nbd-popup.popup-nbo-options")
            .find(".overlay-main")
            .removeClass("active");
          ...
          $timeout(function () {
            ...
            if (jQuery("#nbo-options-wrap .variations_form").length) {
              ...
              jQuery("#nbo-options-wrap .variations_form").trigger(
                "wc_variation_form"
              );
              jQuery(
                "#nbo-options-wrap .variations_form .variations select"
              ).change();
            }
          });
        });
    ...
    $scope.showProducts = function () {
      ...
      jQuery(".nbd-popup.popup-nbd-products")
        .find(".overlay-main")
        .addClass("active");
      NBDDataFactory.get("nbd_get_nbd_products", {}, function (data) {
        ...
        if (_data.length && angular.isDefined(_data[0].product_id)) {
          ...
          jQuery(".nbd-popup.popup-nbd-products .close-popup").triggerHandler(
            "click"
          );
        }
      });
    ...
    $scope.uploadFile = function (files, indexFile) {
      ...
      if (
        ...
        indexFile >
          parseInt($scope.settings.nbdesigner_max_upload_files_at_once) - 1
      )
        return;
      ...
      if (
        ...
        (file.type.indexOf("pdf") != -1 &&
          !$scope.settings.is_available_imagick)
      ) {
        alert(
          $scope.settings.is_available_imagick
            ? $scope.settings.nbdlangs.supported_extensions2
            : $scope.settings.nbdlangs.supported_extensions
        );
        return;
      }
      ...
      if (file.type.indexOf("svg") > -1) {
        ...
        NBDDataFactory.get(
          ...
          function (data) {
            var data = JSON.parse(data);
            if (data.flag == 1) {
              if (angular.isDefined(data.ilr))
                $scope.resource.upload.ilr = true;
              if (
                $scope.resource.upload.ilr &&
              ...
              jQuery("#tab-photo .tab-scroll")
                ...
                .animate(
                  {
                    scrollTop: jQuery("#tab-photo .tab-scroll").prop(
                      "scrollHeight"
                    ),
                  },
                  100
            ...
            if (data.is_login == 1) {
              ...
              if (checkMobileDevice()) {
                ...
                if (jQuery(".popup-login .main-body iframe").length == 0) {
                  jQuery(".popup-login .main-body").prepend(
                    '<iframe id="nbd-login-frame"  width="100%" height="100%" scrolling="yes" frameborder="0" noresize="noresize" allowfullscreen mozallowfullscreen="true" webkitallowfullscreen="true" src="' +
                      iframe_src +
                      '"></iframe>'
                  );
                  ...
                  setTimeout(function () {
                    var interval;
                    jQuery(".popup-login .main-body iframe").on(
                      "load",
                      function () {
                        jQuery(".popup-login .overlay-main").hide();
                        jQuery(".popup-login .main-body iframe")
                          .contents()
                          .find("head")
                          .append(
                        ...
                        interval = setInterval(function () {
                          try {
                            ...
                            if (location.hash.length) {
                              ...
                              jQuery(
                                ".popup-login .main-popup .close-popup"
    ...
    $scope.onEndRepeat = function (type) {
      ...
      if (type == "background") {
        $scope.renderMasonryList(
          type,
          "#tab-background .background-wrap",
          ".background-item",
          "#tab-background",
          $scope.resource[type].init
        );
    ...
    $scope.renderMasonryList = function (
      type,
      container,
      item,
      scrollContainer,
        ...
        jQuery.each(jQuery(container + " " + item), function (e) {
          ...
          if (checkMobileDevice()) {
            ...
            jQuery(this).addClass(
              "in-view slideInDown animated animate" + animate
            );
          }
        });
    ...
    $scope.scrollLoadMore = function (container, type) {
      ...
      if (type == "photo" && $scope.resource.personal.status) {
        ...
        if (
          $scope.resource[photoType].filter.currentPage *
            $scope.resource[photoType].filter.perPage <
          $scope.resource[photoType].filter.total
        ) {
      ...
      if (type == "element") {
        ...
        if (
          ["icon", "shape", "line", "flaticon", "storyset"].indexOf(
            elementType
          ) > -1
        ) {
          if (
            $scope.resource[elementType].filter.currentPage <
            $scope.resource[elementType].filter.totalPage
          ) {
        ...
        if (elementType == "photoFrame") {
          if (
            $scope.resource[elementType].filter.currentPage *
              $scope.resource[elementType].filter.perPage <
            $scope.resource[elementType].filter.total
          ) {
            $scope.resource[elementType].filter.currentPage += 1;
          } else {
            jQuery(container + " .loading-photo").hide();
      ...
      if (type == "globalTemplate") {
        if ($scope.resource.templateLimit < $scope.resource.templates.length) {
          ...
          if (
            $scope.resource[type].filter.currentPage <
            $scope.resource[type].filter.totalPage
          ) {
            $scope.resource[type].filter.currentPage += 1;
            $scope.toggleStageLoading();
      ...
      if (
        $scope.resource[type].filter.currentPage *
          $scope.resource[type].filter.perPage >=
        $scope.resource[type].filter.total
      ) {
        jQuery(container + " .loading-photo").hide();
        return;
      ...
      switch (type) {
        ...
        case "photo":
          $scope.resource[type].onload = true;
          !$scope.resource.personal.status &&
            $scope.getPhoto($scope.resource.photo.type, "more");
          break;
      }
    ...
    $scope.generateTypoLink = function (typo) {
      if ($scope.settings.task == "typography") {
        return (
          NBDESIGNCONFIG["plg_url"] + "/data/typography/img/" + typo.id + ".png"
        );
      } else {
        return (
          "//dpeuzbvf3y4lr.cloudfront.net/typography/" +
          typo.folder +
          "/preview.png"
        );
      }
    ...
    $scope.downloadMockupPreview = function () {
      jQuery(".nbd-popup.popup-nbd-mockup-preview")
        .find(".overlay-main")
        .addClass("active");
      var mockups = "";
    ...
    $scope.cancelMockupPreview = function () {
      jQuery(".nbd-popup.popup-nbd-mockup-preview .close-popup").triggerHandler(
        "click"
      );
    };
    ...
    $scope.reloadTemplateTags = function () {
      $http({
        method: "GET",
        url:
          NBDESIGNCONFIG["ajax_url"] +
          "?action=nbd_get_template_tags&nonce=" +
          NBDESIGNCONFIG["nonce"],
      }).then(
        function successCallback(response) {
          if (
            angular.isDefined(response.data.flag) &&
    ...
    $scope.addTemplateColor = function (color) {
      ...
      $scope.customTemplate.selectedColors = _.uniq(
        $scope.customTemplate.selectedColors
      );
    ...
    $scope.saveData = function (type) {
      ...
      jQuery(".variations_form, form.cart")
        .find('[name="nbo-ignore-design"]')
        .remove();
      if (
        angular.isUndefined(type) &&
        angular.isDefined(nbd_window.nbOption) &&
        angular.isDefined(nbd_window.nbOption.odOption) &&
        angular.isDefined(nbd_window.nbOption.odOption.page) &&
        angular.isDefined(nbd_window.nbOption.odOption.page.list_page) &&
        nbd_window.nbOption.odOption.page.list_page.length == 0
      ) {
        if (
          NBDESIGNCONFIG.show_nbo_option == "1" &&
          NBDESIGNCONFIG.task == "new" &&
          NBDESIGNCONFIG.task2 == ""
        ) {
          nbd_window
            .jQuery(".variations_form, form.cart")
            .append(
              '<input name="nbo-ignore-design" type="hidden" value="1" />'
            );
      ...
      function _saveData() {
        ...
        if (angular.isDefined($scope.settings.product_data.origin_product)) {
          $scope.resource.config.origin_product =
            $scope.settings.product_data.origin_product;
        }
        ...
        if (
          angular.isDefined($scope.areaDesignShapes) &&
          $scope.areaDesignShapes.length
        ) {
        ...
        if (
          ...
          $scope.resource.config.combinationColor =
            $scope.currentCombinationColor;
        }
        var dataObj = {};
        dataObj.used_font = new Blob(
          [JSON.stringify($scope.resource.usedFonts)],
          { type: "application/json" }
        );
        if (type == "template")
          $scope.resource.jsonDesign.canvas = {
            width: $scope.templateSize.width,
            height: $scope.templateSize.height,
          };
        dataObj.design = new Blob(
          [JSON.stringify($scope.resource.jsonDesign)],
          { type: "application/json" }
        );
        _.each($scope.stages, function (stage, index) {
          ...
          if (
            angular.isDefined($scope.partialSvgs[index]) &&
            $scope.partialSvgs[index].length
          ) {
            $scope.partialSvgs[index].forEach(function (
              partialSvg,
              partialIndex
            ) {
              var partial_svg_key =
                "frame_" + index + "_svg_part_" + partialIndex;
              dataObj[partial_svg_key] = new Blob([partialSvg], {
                type: "image/svg",
              });
            });
          }
        ...
        switch (type) {
          ...
          default:
            ...
            if (type == "change-product")
              dataObj["switched_product"] = $scope.switchedProduct;
            dataObj["nbd_file"] = "";
            dataObj.config = new Blob(
              [JSON.stringify($scope.resource.config)],
              { type: "application/json" }
            );
            ...
            $timeout(function () {
              ...
              if (type == "save_draft") {
                ...
                if (
                  angular.isDefined($scope.resource.draft_folder) &&
                  $scope.resource.draft_folder != ""
                )
                  dataObj.draft_folder = $scope.resource.draft_folder;
              }
              ...
              if (
                ...
                if ($scope.customTemplate.type == 2) {
                  dataObj["template_thumb"] =
                    $scope.customTemplate.template_thumb;
                }
                ...
                dataObj["template_colors"] =
                  $scope.customTemplate.selectedColors.join(",");
                ...
                if (data.flag == "success") {
                  ...
                  if (type == "preview_mockup") {
                    if (data.mockups) {
                      ...
                      var d = new Date();
                      var share_url =
                        NBDESIGNCONFIG.nbd_create_own_page +
                        "?product_id=" +
                        NBDESIGNCONFIG.product_id +
                        "&variation_id=" +
                        NBDESIGNCONFIG.variation_id +
                        "&reference=" +
                        $scope.resource.social.folder +
                        "&nbd_share_id=" +
                        $scope.resource.social.folder +
                        "&t=" +
                        d.getTime();
                      $scope.resource.social.wa_link =
                        origin_url + encodeURIComponent(share_url);
                      jQuery(".whatsapp_share").attr(
                        "href",
                        $scope.resource.social.wa_link
                      );
                    }
                  ...
                  if (NBDESIGNCONFIG.ui_mode == 3) {
                    if (
                      ...
                      $scope.toggleStageLoading();
                      jQuery(document).triggerHandler("nbd_design_stored", {
                        _type: type,
                      });
                      return;
                    } else {
                  ...
                  if (type == "saveforlater") {
                    ...
                    if (
                      angular.isDefined($scope.selectedMyDesign) &&
                      $scope.selectedMyDesign != ""
                    ) {
                  ...
                  if (type == "share") {
                    ...
                    if (
                      NBDESIGNCONFIG[
                        "nbdesigner_auto_add_cart_in_detail_page"
                      ] == "yes" &&
                      NBDESIGNCONFIG.task == "new" &&
                      NBDESIGNCONFIG.ui_mode == 1 &&
                      !(
                        angular.isDefined(NBDESIGNCONFIG.edit_option_mode) &&
                        NBDESIGNCONFIG.edit_option_mode == "1"
                      )
                    ) {
                      nbd_window
                        .jQuery(".variations_form, form.cart")
                      ...
                      nbd_window
                        .jQuery(nbd_window.document)
                        .triggerHandler("nbd_design_stored", {
                          _type: type,
                          prevent_ajax: 1,
                        });
                    } else {
                      nbd_window.NBDESIGNERPRODUCT.product_id =
                        NBDESIGNCONFIG["product_id"];
                      nbd_window.NBDESIGNERPRODUCT.variation_id =
                        NBDESIGNCONFIG["variation_id"];
                      nbd_window.NBDESIGNERPRODUCT.folder = data.folder;
                      nbd_window.NBDESIGNERPRODUCT.show_design_thumbnail(
                        data.image,
                        NBDESIGNCONFIG["task"],
                        $scope.resource.config
                      );
                      nbd_window.NBDESIGNERPRODUCT.get_sugget_design(
                        NBDESIGNCONFIG["product_id"],
                        NBDESIGNCONFIG["variation_id"]
                      );
                      if (
                        NBDESIGNCONFIG.ui_mode == 1 &&
                        $scope.resource.config.qty != null
                      ) {
                      }
                      if (
                        NBDESIGNCONFIG.ui_mode == 1 &&
                        angular.isDefined(data.gallery)
                      ) {
                        nbd_window
                          .jQuery(nbd_window.document)
                          .triggerHandler("nbd_update_gallery", {
      ...
      if (
        $scope.onSaveData &&
        NBDESIGNCONFIG.nbdesigner_enable_font_to_outlines == "yes"
      ) {
    ...
    $scope.createShareLink = function (type, origin_url) {
      ...
      if (jQuery(".quick-view form .variations select").length) {
        share_url +=
          "&" + jQuery(".quick-view form .variations select").serialize();
      } else if (
        $scope.settings.ui_mode == 1 &&
        nbd_window.jQuery(".variations_form .variations select").length
      ) {
        share_url +=
          "&" +
          nbd_window.jQuery(".variations_form .variations select").serialize();
      }
      $scope.resource.social.link = origin_url + encodeURIComponent(share_url);
      $scope.resource.social.design_link = share_url;
      var comment = angular.isDefined($scope.resource.social.comment)
        ? $scope.resource.social.comment
        : $scope.settings.nbdlangs.my_design;
    ...
    $scope.updateShareLink = function () {
      ...
      if (link.indexOf("&text=") > -1) {
        link =
          link.substr(0, link.indexOf("&text=") + 6) +
          $scope.resource.social.comment;
        ...
        _canvas.forEachObject(function (obj, objIndex) {
          if (
            ...
            var fontName = obj.get("fontFamily"),
              font = _.filter($scope.resource.font.data, {
                alias: fontName,
              })[0],
            ...
            if (fontWeight == "bold") {
              if (fontStyle == "italic") {
                font_url =
                  font.file.bi != 1
                    ? font.file.bi
                    : NBDESIGNCONFIG.default_font.file.bi;
                fontName += "__bi";
              } else {
                font_url =
                  font.file.b != 1
                    ? font.file.b
                    : NBDESIGNCONFIG.default_font.file.b;
                fontName += "__b";
              }
            } else {
              if (fontStyle == "italic") {
                font_url =
                  font.file.i != 1
                    ? font.file.i
                    : NBDESIGNCONFIG.default_font.file.i;
                fontName += "__i";
              } else {
                font_url =
                  font.file.r != 1
                    ? font.file.r
                    : NBDESIGNCONFIG.default_font.file.r;
              }
            }
    ...
    $scope.createPreviewWithClippath = function (index, callback) {
      ...
      function createPreviewSvg() {
        ...
        svg += "<defs>";
        svg +=
          '<clipPath id="area-design-shape-' +
          index +
          '"><path d="' +
          $scope.areaDesignClipPaths[index] +
          '" /></clipPath>';
        svg += "</defs>";
      ...
      img.onload = function () {
        ...
        kanvas.width = width;
        (kanvas.height = height), (context = kanvas.getContext("2d"));
    ...
    $scope.saveDesign = function (downloadType) {
      if (
        $scope.settings.nbdesigner_dimensions_unit == "px" &&
        angular.isDefined(downloadType) &&
        downloadType == "png"
      ) {
        $scope.maybeZoomStage = true;
      }
      ...
      _.each($scope.stages, function (stage, index) {
        ...
        var zoomIndex =
          stage.states.fillScaleIndex != -1
            ? stage.states.fillScaleIndex
            : stage.states.fitScaleIndex;
        ...
        if (
          angular.isDefined($scope.originPDFs[index]) &&
          $scope.originPDFs[index].length
        ) {
        ...
        if (
          angular.isDefined($scope.areaDesignZoomedClipPaths[index]) &&
          $scope.areaDesignZoomedClipPaths[index] &&
          !downloadType
        ) {
          $timeout(function () {
            var clipPath =
            ...
            if (stage.config.bgType == "color") {
              bg =
                '<rect x="0" y="0" width="' +
                stage.config.svgWidth +
                '" height="' +
                stage.config.svgHeight +
                '" fill="' +
                stage.config.bgColor +
                '" />';
            }
            var newSvg = stage.svg.replace(
              "</defs>",
              clipPath +
                '</defs><g clip-path="url(#area-design-shape-' +
                index +
                ')">' +
                bg
            );
          ...
          $scope.onSaveData &&
          NBDESIGNCONFIG.enable_sticker_preview &&
          index == 0
        ) {
        ...
        $scope.resource.usedFonts = _.concat(
          $scope.resource.usedFonts,
          stage.states.usedFonts
        );
      });
      ...
      if (downloadType) {
        ...
        $timeout(function () {
          ...
          _.each($scope.stages, function (stage, index) {
            $timeout(function () {
              var filename =
                  index + 1 + (downloadType == "png" ? ".png" : ".svg"),
                a = document.createElement("a");
              ...
              if (downloadType == "png") {
                ...
                if (
                  angular.isDefined($scope.areaDesignClipPaths[index]) &&
                  $scope.areaDesignClipPaths[index]
                ) {
                  $timeout(function () {
                    $scope.createPreviewWithClippath(index, function () {
    ...
    $scope.wraperClickHandle = function ($event) {
      ...
      if (
        !jQuery($event.target).hasClass("color-palette-add") &&
        $scope.showTextColorPicker &&
        $textPicker.has($event.target).length == 0 &&
        !$textPicker.is($event.target)
      ) {
        $scope.showTextColorPicker = false;
      }
      if (
        !jQuery($event.target).hasClass("color-palette-add") &&
        $scope.showBgColorPicker &&
        $bgPicker.has($event.target).length == 0 &&
        !$bgPicker.is($event.target)
      ) {
        $scope.showBgColorPicker = false;
      }
      if (
        !jQuery($event.target).hasClass("color-palette-add") &&
        $scope.stageBgColorPicker.status &&
        $stageBgPicker.has($event.target).length == 0 &&
        !$stageBgPicker.is($event.target)
      ) {
        $scope.stageBgColorPicker.status = false;
      }
      if (
        !jQuery($event.target).hasClass("color-palette-add") &&
        $scope.globalPicker.active &&
        $globalPicker.has($event.target).length == 0 &&
        !$globalPicker.is($event.target)
      ) {
          ...
          switch (e.which) {
            ...
            case 66:
              ...
              if (
                ...
                (_states.text.fontStyle != "italic" ||
                  (_states.text.fontStyle == "italic" &&
                    _states.text.font.file.bi))
              ) {
                $scope.setTextAttribute(
                  "fontWeight",
                  _states.text.fontWeight == "bold" ? "normal" : "bold"
                );
              }
              $scope.updateApp();
              break;
            ...
            case 73:
              ...
              if (
                ...
                (_states.text.fontWeight != "bold" ||
                  (_states.text.fontWeight == "bold" &&
                    _states.text.font.file.bi))
              ) {
                $scope.setTextAttribute(
                  "fontStyle",
                  _states.text.fontStyle == "italic" ? "normal" : "italic"
                );
              }
              $scope.updateApp();
              break;
        ...
        switch (e.which) {
          ...
          case 86:
            ...
            if ($scope.resource.drawMode.status)
              jQuery('.item[data-type="draw"]').triggerHandler("click");
            break;
          case 66:
    ...
    $scope.onClickStage = function ($event) {
      ...
      if (angular.element($event.target).hasClass("stage")) {
        ...
        if ($scope.settings.nbdesigner_save_latest_design == "yes") {
          ...
          var pid =
            NBDESIGNCONFIG["product_id"] + "-" + NBDESIGNCONFIG["variation_id"];
    ...
    $scope.contextMenu = function (e) {
      if (
        $scope.stages[$scope.currentStage].states.isEditing ||
        $scope.stages[$scope.currentStage].states.isMask
      )
        return;
      e.preventDefault();
      var posX = e.pageX,
        posY = e.pageY;
      var contextEl = angular.element(
          document.getElementById("nbd-context-menu")
        )[0],
        height = contextEl.clientHeight,
        width = contextEl.clientWidth;
      if ($scope.workBenchWidth < posX + width + 15)
        posX = $scope.workBenchWidth - width - 15;
      if ($scope.workBenchHeight < posY + height + 15)
        posY = $scope.workBenchHeight - height - 15;
      $scope.ctxMenuStyle = {
        visibility: "visible",
        top: posY,
        left: posX,
    ...
    $scope.selectGlobalPicker = function (color) {
      ...
      if (attr_arr.length == 2 && attr_arr[0] == "text") {
        ...
        $scope.stages[$scope.currentStage].states.shadow.color =
          $scope.globalPicker.color;
        $timeout(function () {
    ...
    $scope.$on("canvas:created", function (event, id, last) {
      ...
      if ($scope.duplicateStageIndex == id) {
        ...
        $scope.contextAddLayers = "template";
        $scope.onloadTemplate = true;
        $scope.stages[id].canvas.loadFromJSON(
          $scope.resource.jsonDesign[id],
          function () {
            $scope.onloadTemplate = false;
            $scope.contextAddLayers = "normal";
          }
    ...
    $scope.loadTemplateAfterRenderCanvas = function () {
      ...
      if (
        !$scope.isTemplateMode ||
        ($scope.isTemplateMode && $scope.settings.task == "edit")
      ) {
        $timeout(function () {
          function loadTemplate() {
            if (
              $scope.the_first_time_load_page &&
              angular.isDefined(
                $scope.settings.product_data.lazy_load_design_folder
              ) &&
              $scope.settings.product_data.lazy_load_design_folder != ""
            ) {
              $scope.insertTemplate(false, {
                id: $scope.settings.product_data.lazy_load_design_folder,
              });
              ...
              var config =
                $scope.the_first_time_load_page &&
                angular.isDefined($scope.settings.product_data.config_ref)
                  ? $scope.settings.product_data.config_ref
                  : $scope.settings.product_data.config;
              var viewport = config.viewport;
              $scope.the_first_time_load_page = false;
              if (
                angular.isUndefined(config.viewport) &&
                angular.isDefined(config.scale)
              ) {
                viewport = {
              ...
              if (angular.isDefined($scope.settings.product_data.design_id)) {
                NBDESIGNCONFIG.design_id =
                  $scope.settings.product_data.design_id;
              }
            } else {
              if (
                NBDESIGNCONFIG.product_data.option.admindesign == "1" &&
                ...
                NBDESIGNCONFIG.product_data.option.global_template == "1" &&
                NBDESIGNCONFIG.product_data.option.global_template_cat != "" &&
                $scope.settings.nbdesigner_disable_auto_load_template == "no"
              ) {
                var interval = setInterval(function () {
                  if ($scope.globalTemplateLoaded) {
                    if ($scope.resource.globalTemplate.data.length > 0) {
                      $scope.insertGlobalTemplate(
          ...
          if (
            angular.isDefined($scope.settings.product_data.is_template) ||
            $scope.settings.task == "create_template"
          ) {
            loadLocalDesign();
          } else {
      ...
      _.each($scope.stages, function (stage, index) {
        ...
        if (angular.isDefined($scope.settings.nbes_enable_settings)) {
          ...
          if ($scope.settings.nbes_enable_settings.combination == 1) {
            if (
              angular.isDefined(
                $scope.settings.nbes_settings.combination_colors
              ) &&
              angular.isDefined(
                $scope.settings.nbes_settings.combination_colors.bg_codes
              ) &&
              $scope.settings.nbes_settings.combination_colors.bg_codes.length >
                0
            ) {
              forceBg = true;
              color =
            ...
            if (
              angular.isDefined(
                $scope.settings.nbes_settings.background_colors
              ) &&
              angular.isDefined(
                $scope.settings.nbes_settings.background_colors.codes
              ) &&
    ...
    $scope.processProductSettings = function () {
      ...
      switch ($scope.settings.nbdesigner_dimensions_unit) {
        ...
        case "px":
          unitRatio =
            2.54 / parseFloat($scope.settings.product_data.option.dpi);
          break;
        default:
          unitRatio = 1;
          break;
      }
      $scope.rateConvert2Px =
        ($scope.rateConvertCm2Px96dpi *
          unitRatio *
          parseFloat($scope.settings.product_data.option.dpi)) /
        96;
      var viewPort = $scope.calcViewport();
      var scaleRange = [
          0.1, 0.25, 0.3, 0.5, 0.75, 1, 1.25, 1.5, 1.75, 2, 3, 4, 5,
        ],
      ...
      _.each($scope.settings.product_data.product, function (side, index) {
        var _width = side.product_width * $scope.rateConvert2Px,
          ...
          designViewPort = $scope.fitRectangle(
            viewPort.width,
            viewPort.height,
            _width,
            _height,
          ...
          minScale =
            200 / Math.max(designViewPort.width, designViewPort.height),
          maxScale =
            maxSize / Math.max(designViewPort.width, designViewPort.height),
          screenViewPort = $scope.fitRectangle(
            screen.width,
            screen.height,
            _width,
            _height,
        ...
        $scope.stages[index] = {
          config: {
            ...
            width:
              (designViewPort.width * side.real_width) / side.product_width,
            height:
              (designViewPort.width * side.real_height) / side.product_width,
            ...
            bleed_lr:
              (designViewPort.width * side.bleed_left_right) /
              side.product_width,
            bleed_tb:
              (designViewPort.width * side.bleed_top_bottom) /
              side.product_width,
            margin_lr:
              (designViewPort.width * side.margin_left_right) /
              side.product_width,
            margin_tb:
              (designViewPort.width * side.margin_top_bottom) /
              side.product_width,
        ...
        if (angular.isDefined(side.bleed_radius) && side.bleed_radius != 0) {
          $scope.stages[index].config.bleed_radius =
            (designViewPort.width * side.bleed_radius) / side.product_width;
          $scope.stages[index].config.safezone_radius =
            (designViewPort.width * side.safezone_radius) / side.product_width;
        }
        ...
        _state.ratioConvertFont =
          (designViewPort.width /
            ((side.product_width / unitRatio) * 2.54 * 72)) *
          factor;
        ...
        if (fillScale >= minScale && fillScale <= maxScale)
          _state.scaleRange.push({
            ratio: fillScale,
        ...
        var printScale = 0;
        if (
          printSizeWidth < maxSize &&
          printSizeHeight < maxSize &&
          printSizeWidth > minScale &&
          printSizeHeight > minScale
        ) {
        ...
        _state.scaleRange = _.sortBy(_state.scaleRange, [
          function (o) {
            return o.ratio;
          },
        ]);
        ...
        _state.fullScreenScaleIndex = _.findIndex(
          _state.scaleRange,
          function (o) {
        ...
        $timeout(function () {
          if (
            angular.isDefined($scope.areaDesignShapes[index]) &&
            $scope.areaDesignShapes[index]
          ) {
      ...
      if (
        $scope.settings.task == "typography" ||
        $scope.settings.task == "create_template"
      ) {
        $scope.stages = [
          {
            ...
            states: {
              scaleRange: [
                { ratio: 1, value: "100%", label: "Fit" },
                { ratio: 2, value: "200%", label: "200%" },
        ...
        if ($scope.settings.task == "create_template")
          $scope.stages[0].states.scaleRange = [
            { ratio: 1, value: "100%", label: "Fit" },
            { ratio: 2, value: "200%", label: "200%" },
            { ratio: 3, value: "300%", label: "300%" },
            { ratio: 4, value: "400%", label: "400%" },
            { ratio: 5, value: "500%", label: "500%" },
          ];
    ...
    $scope.changeAreaDesignShape = function (stageIndex, svg) {
      jQuery("#stage-container-" + stageIndex + " .stage-area-design-shape")
        .html("")
        .append(svg);
    ...
    $scope.processAreaDesignShape = function (index) {
      ...
      if (angular.isUndefined(stage)) return;
      if (
        angular.isUndefined($scope.areaDesignShapes[index]) &&
        $scope.areaDesignShapes[index]
      )
        return;
      ...
      function getTransformedPathDStr(
        oldPathDStr,
        pathTranslX,
        pathTranslY,
        scale
          ...
          if (/^[A-Za-z]$/.test(oldPathDComp)) {
            ...
            switch (commandParams) {
              case BOTH_X_AND_Y:
                ...
                newPathDArr[idx + 1] =
                  Number(oldPathDArr[idx + 1]) * scale.Y + translY;
                idx += 2;
                break;
              case JUST_X:
                newPathDArr[idx] = Number(oldPathDArr[idx]) * scale.X + translX;
              ...
              case ELLIPTICAL_ARC:
                ...
                newPathDArr[idx + 5] =
                  Number(oldPathDArr[idx + 5]) * scale.X + translX;
                newPathDArr[idx + 6] =
                  Number(oldPathDArr[idx + 6]) * scale.Y + translY;
                idx += 7;
                break;
              case NONE:
                throw new Error(
      ...
      function getTranslationAndScaling(origPathBoundingBox, svgWdth, svgHght) {
        ...
        if (origPathWdth == 0)
          return { pathTranslX: 0, pathTranslY: 0, scale: { X: 1, Y: 1 } };
      ...
      $timeout(function () {
        if (
          jQuery("#stage-container-" + index + " .stage-area-design-shape svg")
            .length == 0
        )
          return;

        var _viewBox =
            $scope.areaDesignShapes[index].match(/viewBox="(.*?)"/)[1],
          viewBox = _viewBox.split(/\s+|,/);

        var defs = makeSVGElement("defs", {}),
          clipPath = makeSVGElement("clipPath", {
            id: "area-design-shape-" + index,
          }),
          svg = document.querySelector(
            "#stage-container-" + index + " .stage-area-design-shape svg"
          ),
          path = document.querySelector(
            "#stage-container-" + index + " .stage-area-design-shape svg > path"
          );
        ...
        var stageScale =
          stage.states.scaleRange[stage.states.currentScaleIndex].ratio;
        var obj = getTranslationAndScaling(
            origPathBoundingBox,
            svgWdth,
            svgHght
          ),
          zoomedObj = getTranslationAndScaling(
            origPathBoundingBox,
            svgWdth / stageScale,
            svgHght / stageScale
          ),
          ...
          newPathDStr = getTransformedPathDStr(
            d,
            pathTranslX,
            pathTranslY,
            scale
          ),
          newZoomedPathDStr = getTransformedPathDStr(
            d,
            zoomedPathTranslX,
            zoomedPathTranslY,
            zoomedScale
        ...
        jQuery("#stage-container-" + index + " .stage-area-design-shape svg")
          .removeAttr("viewBox")[0]
          .setAttribute(
            "viewBox",
            viewBox[0] + " " + viewBox[1] + " " + svgWdth + " " + svgHght
          );

        var bleedWidth =
            stage.states.scaleRange[stage.states.currentScaleIndex].ratio *
            (stage.config.width - 2 * stage.config.bleed_lr),
          bleedHeight =
            stage.states.scaleRange[stage.states.currentScaleIndex].ratio *
            (stage.config.height - 2 * stage.config.bleed_tb),
          safeZoneWidth =
            stage.states.scaleRange[stage.states.currentScaleIndex].ratio *
            (stage.config.width -
              2 * stage.config.bleed_lr -
              2 * stage.config.margin_lr),
          safeZoneHeight =
            stage.states.scaleRange[stage.states.currentScaleIndex].ratio *
            (stage.config.height -
              2 * stage.config.bleed_tb -
              2 * stage.config.margin_tb),
        ...
        jQuery("#stage-container-" + index + " .bleed-line")
          .html("")
          .append($scope.areaDesignShapes[index]);
        jQuery("#stage-container-" + index + " .safe-line")
          .html("")
          .append($scope.areaDesignShapes[index]);

        var bleedObj = getTranslationAndScaling(
            origPathBoundingBox,
            bleedWidth,
            bleedHeight
          ),
          safeZoneObj = getTranslationAndScaling(
            origPathBoundingBox,
            safeZoneWidth,
            safeZoneHeight
          ),
          ...
          newBleedPathDStr = getTransformedPathDStr(
            d,
            bleedPathTranslX,
            bleedPathTranslY,
            bleedScale
          ),
          newSafeZonePathDStr = getTransformedPathDStr(
            d,
            safeZonePathTranslX,
            safeZonePathTranslY,
            safeZoneScale
        ...
        jQuery("#stage-container-" + index + " .bleed-line svg")
          .removeAttr("viewBox")[0]
          .setAttribute(
            "viewBox",
            viewBox[0] + " " + viewBox[1] + " " + bleedWidth + " " + bleedHeight
          );
        jQuery("#stage-container-" + index + " .bleed-line svg path").attr({
          d: newBleedPathDStr,
        });
        //jQuery('#stage-container-' + index + ' .safe-line svg path').attr({d: newSafeZonePathDStr, transform: 'scale(' + safeZoneScaleX + ', ' + safeZoneScaleY + ')'});
        jQuery("#stage-container-" + index + " .safe-line svg")
          .removeAttr("viewBox")[0]
          .setAttribute(
            "viewBox",
            viewBox[0] +
        ...
        jQuery("#stage-container-" + index + " .safe-line svg path").attr({
          d: newSafeZonePathDStr,
        });
    ...
    $scope.removeAreaDesignShape = function (stageIndex) {
      jQuery(
        "#stage-container-" + stageIndex + " .stage-area-design-shape"
      ).html("");
    ...
    $scope.calcStyleGuideline = function (line, cf, ratio, direction) {
      ...
      if (direction == "hor") {
        style.top =
          (line.top > 40 ? 40 + (line.top - 40) * ratio - 3 : line.top - 3) +
          "px";
        style.width =
          (cf.cwidth * ratio > viewPort.width
            ? cf.cwidth * ratio
            : viewPort.width) +
          100 +
          "px";
        ...
        if (additionalPadding < 0) {
          if (line.left <= 50) {
            ...
            style.left =
              viewPort.width / 2 -
              (viewPort.width / 2 - (line.left - 50)) * ratio +
              50;
          }
        } else {
          style.left =
        ...
        style.height =
          (cf.cheight * ratio > viewPort.height
            ? cf.cheight * ratio
            : viewPort.height) +
          90 +
          "px";
    ...
    $scope.showTemplateFieldsPopup = function (force) {
      if (
        !$scope.settings.is_mobile &&
        ($scope.settings.ui_mode == 1 || $scope.settings.ui_mode == 2) &&
        NBDESIGNCONFIG.nbdesigner_enable_template_mapping == "yes" &&
        $scope.firstTimeShowTemplateFiledsPopup &&
        NBDESIGNCONFIG.is_logged != 1 &&
        !$scope.tourGuideShowing &&
        $scope.templateHolderFields.length > 0
      ) {
        $timeout(function () {
        ...
        _.each($scope.templateHolderFields, function (field, index) {
          if (field.value != "") {
            _.each($scope.stages, function (stage, index) {
              ...
              _canvas.forEachObject(function (obj) {
                if (
                  angular.isDefined(obj.field_mapping) &&
                  field.key == obj.field_mapping
                ) {
    ...
    $scope.addStage = function (duplicate) {
      ...
      if (
        angular.isDefined($scope.settings.product_data.option.new_side_name)
      ) {
        ...
        new_stage.config.name =
          $scope.settings.product_data.option.new_side_name;
        var max_number_side = parseInt(
          $scope.settings.product_data.option.max_number_side
        );
        if (
          $scope.settings.product_data.origin_product.length +
            max_number_side ==
          $scope.stages.length
        ) {
      ...
      angular.copy(
        $scope.settings.product_data.product[$scope.currentStage],
        new_side_config
      );
      $scope.settings.product_data.product.splice(
      ...
      if (duplicate) {
        ...
        angular.copy(
          _canvas.toJSON($scope.includeExport),
          $scope.resource.jsonDesign[$scope.currentStage + 1]
        );
      }
      ...
      $scope.updateApp();
      if (
        angular.isDefined($scope.settings.product_data.option.max_number_side)
      ) {
        if (
          $scope.settings.product_data.origin_product.length +
            parseInt($scope.settings.product_data.option.max_number_side) ==
          $scope.stages.length
        ) {
          $scope.resource.canAdd = false;
        }
      ...
      $timeout(function () {
        ...
        if (stageLen == currentStage + 1) {
          $scope.contextAddLayers = "template";
          $scope.onloadTemplate = true;
          $scope.stages[stageLen].canvas.loadFromJSON(
            $scope.resource.jsonDesign[stageLen],
            function () {
              $scope.onloadTemplate = false;
              $scope.contextAddLayers = "normal";
            }
    ...
    $scope.setStageDimension = function (id) {
      ...
      var currentWidth =
          _stage.config.width *
          _stage.states.scaleRange[_stage.states.currentScaleIndex].ratio,
        currentHeight =
          _stage.config.height *
          _stage.states.scaleRange[_stage.states.currentScaleIndex].ratio;
    ...
    $scope.switchStage = function (id, command, direction, onRemoveStage) {
      ...
      jQuery(
        ".nbd-stages .ps__scrollbar-x-rail, .nbd-stages .ps__scrollbar-y-rail"
      ).addClass("nbd-hiden");
      $timeout(function () {
        jQuery(
          ".nbd-stages .ps__scrollbar-x-rail, .nbd-stages .ps__scrollbar-y-rail"
        ).removeClass("nbd-hiden");
      }, 700);
      direction = angular.isDefined(direction) ? direction : "top-bottom";
      var fadeInNext = "fadeInUp",
        fadeInPrev = "fadeInDown",
        fadeOutNext = "fadeOutDown",
      ...
      var currentStage = angular.element(
          document.getElementById(idCurrentStage)
        ),
        ...
        case "image":
          ...
          var interval = $interval(function () {
            if ($scope.stageEvent.dropped) {
              $interval.cancel(interval);
              if (
                !!$scope.stageEvent.target &&
                !!$scope.stageEvent.target.get("itemId") &&
                !!$scope.stageEvent.target.get("maskId")
              ) {
    ...
    $scope.onDblclick = function (options) {
      ...
      if (item) {
        if (item.type === "activeSelection") {
          ...
          !!item.get("maskId") &&
          !$scope.stages[$scope.currentStage].states.lockMask
        ) {
          $scope.editMask();
          var _stage = $scope.stages[$scope.currentStage];
    ...
    $scope.onMouseOutStage = function (id, options) {
      if (options.target) {
        angular.merge(
          $scope.stages[$scope.currentStage].states.boundingObject,
          { visibility: "hidden" }
        );
      }
      $scope.updateApp();
    ...
    $scope.onMouseMoveStage = function (id, options) {
      if ($scope.settings.showRuler && appConfig.isModern) {
        ...
        if (_stage.hozRuler) {
          ...
          var x =
              (pointer.x + _stage.config.top) *
              _stage.states.scaleRange[_stage.states.currentScaleIndex].ratio,
            y =
              (pointer.y + _stage.config.top) *
              _stage.states.scaleRange[_stage.states.currentScaleIndex].ratio;
      ...
      if (
        ...
        if (item && item.type != "activeSelection") {
          var scaleX = item.get("scaleX"),
            ...
            distance = Math.sqrt(
              (pageX1 - pageX2) * (pageX1 - pageX2) +
                (pageY1 - pageY2) * (pageY1 - pageY2)
            );
    ...
    $scope.onObjectAdded = function (id, options) {
      ...
      item.setCoords();
      if (
        ["normal", "copy", "undo", "redo"].indexOf($scope.contextAddLayers) >
          -1 &&
        _stage.config.area_design_type == "2"
      )
      ...
      if (
        ...
        item.animate("top", top, {
          ...
          onComplete: function () {
            ...
            $scope.setHistory($scope.currentStage, true);
            $scope.stages[$scope.currentStage].tempParameters = JSON.stringify(
              item.toJSON()
            );
        ...
        item.animate(
          { top: top, left: left },
          {
            ...
            onComplete: function () {
              ...
              $scope.setHistory($scope.currentStage, true);
              $scope.stages[$scope.currentStage].tempParameters =
      ...
      if (!$scope.onloadTemplate) {
        if ($scope.onUnloadGroup.status) {
          if (angular.isDefined($scope.onUnloadGroup.prevIndex)) {
            item.moveTo(
              parseInt($scope.onUnloadGroup.prevIndex) +
                $scope.onUnloadGroup.length -
                $scope.onUnloadGroup.remain
            );
          }
          if (
            type == "i-text" ||
    ...
    $scope.updateAssociateLayer = function (item) {
      if (item) {
        var d = new Date(),
          t = d.getTime();
        if (
          $scope.stages[$scope.currentStage].states.coordinates.lastCheck <
          t - 20
        ) {
          item.setCoords();
        ...
        switch ($scope.settings.snapMode.type) {
          ...
          case "bounding":
            if (Math.abs(bound.left - _canvas.width) < threshold) {
              ...
              Math.abs(bound.left + bound.width - _canvas.width) < threshold
            ) {
              translateLeft =
                (_canvas.width - bound.width - bound.left) / scale;
          ...
          case "grid":
            ...
            if (
              item.left * scale -
                Math.round((item.left * scale) / grid) * grid <
              threshold
            ) {
              item.set({
            ...
            if (
              item.top * scale - Math.round((item.top * scale) / grid) * grid <
              threshold
            ) {
              item.set({
    ...
    $scope.updateUploadZone = function (item) {
      ...
      if ((type == "image" || type == "custom-image") && elementUpload) {
        angular.merge($scope.stages[$scope.currentStage].states.uploadZone, {
          ...
          width:
            Math.sqrt(
              Math.pow(item.oCoords.tl.x - item.oCoords.tr.x, 2) +
                Math.pow(item.oCoords.tl.y - item.oCoords.tr.y, 2)
            ) + 2,
          height:
            Math.sqrt(
              Math.pow(item.oCoords.tl.x - item.oCoords.bl.x, 2) +
                Math.pow(item.oCoords.tl.y - item.oCoords.bl.y, 2)
            ) + 2,
    ...
    $scope.updateCoordenatesLabel = function (item) {
      if (item) {
        ...
        if (
          (item.angle > 315 && item.angle < 360) ||
          (item.angle > 45 && item.angle < 90) ||
          (item.angle > 135 && item.angle < 180) ||
          (item.angle > 225 && item.angle < 270)
        ) {
    ...
    $scope.updateBoundingRect = function (item) {
      ...
      if (item) {
        ...
        stage.states.boundingRealSize = {
          size:
            (
              ((item.width * item.scaleX) / stage.config.cwidth) *
              stage.config.pWidth
            ).toFixed(2) +
            "x" +
            (
              ((item.height * item.scaleY) / stage.config.cheight) *
              stage.config.pHeight
            ).toFixed(2) +
            "" +
            $scope.settings.nbdesigner_dimensions_unit,
          transform:
            item.angle > 270 || item.angle < 90
              ? "rotate(0deg)"
              : "rotate(180deg)",
        };
        $scope.updateApp();
        ...
        if (controls || items.length) {
          var canvasWidth =
            ...
            canvasHeight =
              stage.config.height *
              stage.states.scaleRange[stage.states.currentScaleIndex].ratio;
          ["tl", "tr", "br", "bl", "ml", "mt", "mr", "mb", "mtr"].forEach(
            function (control) {
              if ((controls && controls[control]) || items.length) {
                var _style = {
                  left:
                    item.oCoords[control].x -
                    fabric.Object.prototype.cornerSize / 2,
                  top:
                    item.oCoords[control].y -
                    fabric.Object.prototype.cornerSize / 2,
                ...
                if (
                  item.oCoords[control].x < 0 ||
                  item.oCoords[control].x > canvasWidth ||
                  item.oCoords[control].y < 0 ||
                  item.oCoords[control].y > canvasHeight
                ) {
      ...
      if (item) {
        ...
        _canvas.forEachObject(function (obj) {
          ...
          if (Math.abs(bound.left - _bound.left) < 1)
            position.vl.left = _bound.left;
          if (Math.abs(bound.left + bound.width - _bound.left) < 1)
            position.vr.left = _bound.left;
          if (Math.abs(bound.left - _bound.left - _bound.width) < 1)
            position.vl.left = _bound.left + _bound.width;
          if (Math.abs(bound.top - _bound.top) < 1)
            position.ht.top = _bound.top;
          if (Math.abs(bound.top + bound.height - _bound.top) < 1)
            position.ht.top = _bound.top;
          if (Math.abs(bound.top - _bound.top - _bound.height) < 1)
            position.hb.top = _bound.top + _bound.height;
          if (
            Math.abs(bound.left + bound.width - _bound.left - _bound.width) < 1
          )
            position.vr.left = _bound.left + _bound.width;
          if (
            Math.abs(bound.top + bound.height - _bound.top - _bound.height) < 1
          )
            position.hb.top = _bound.top + _bound.height;
          if (
            Math.abs(
              bound.left + bound.width / 2 - _bound.left - _bound.width / 2
            ) < 1
          )
            position.vc.left = _bound.left + _bound.width / 2;
          if (
            Math.abs(
              bound.top + bound.height / 2 - _bound.top - _bound.height / 2
            ) < 1
          )
            position.hc.top = _bound.top + _bound.height / 2;
        });
        if (Math.abs(bound.left + bound.width / 2 - _canvas.width / 2) < 1)
          position.vcc.left = _canvas.width / 2;
        if (Math.abs(bound.top + bound.height / 2 - _canvas.height / 2) < 1)
          position.hcc.top = _canvas.height / 2;
        ...
        if (Math.abs(bound.left + bound.width - _canvas.width) < 1)
          position.ver.left = _canvas.width;
        if (Math.abs(bound.top + bound.height - _canvas.height) < 1)
          position.heb.top = _canvas.height;

        angular.merge(
          $scope.stages[$scope.currentStage].states.snaplines,
          position
        );
      }
    };
    $scope.updateWarning = function (item) {
      if ($scope.settings.showWarning.oos) {
        ...
        if (
          bound.left < 0 ||
          bound.top < 0 ||
          bound.left + bound.width > _canvas.width ||
          bound.top + bound.height > _canvas.height
        ) {
    ...
    $scope.onObjectModified = function (id, options) {
      ...
      newAngle =
        Math.abs(item.angle - 0) <= 1 || Math.abs(item.angle - 360) <= 1
          ? 0
          : Math.abs(item.angle - 180) <= 1
          ? 180
          : newAngle;
      ...
      $scope.setHistory($scope.currentStage, true);
      if (
        $scope.stages[$scope.currentStage].states.isText &&
        $scope.stages[$scope.currentStage].states.type != "curvedText" &&
        ...
        var newPtFontSize =
          newFontSize /
          $scope.stages[$scope.currentStage].states.ratioConvertFont;
        ...
        $scope.stages[$scope.currentStage].states.text.ptFontSize =
          newPtFontSize;
      }
      ...
      _canvas.forEachObject(function (obj, index) {
        if (angular.isDefined(obj.origin_pdf)) {
          $scope.originPDFs[$scope.currentStage].push({
            ...
            top:
              (obj.oCoords.tl.y / _stage.config.cheight) *
              _stage.config.pHeight,
            left:
              (obj.oCoords.tl.x / _stage.config.cwidth) * _stage.config.pWidth,
            width:
              ((obj.width * obj.scaleX) / _stage.config.cwidth) *
              _stage.config.pWidth,
            height:
              ((obj.height * obj.scaleY) / _stage.config.cheight) *
              _stage.config.pHeight,
          });
        }
      });
    ...
    $scope.onAfterRender = function (id, options) {
      ...
      $scope.stages[$scope.currentStage].states.lostCharLayers = $scope.stages[
        $scope.currentStage
      ].states.lostCharLayers.filter(function (layerId) {
    ...
    $scope.onSelectionChanged = function (id, options) {
      ...
      if ($scope.stages[$scope.currentStage].states.isGroup) {
        ...
        ($scope.stages[$scope.currentStage].states.isShape ||
          $scope.stages[$scope.currentStage].states.isPath) &&
        NBDESIGNCONFIG.nbdesigner_clipart_rotate == "0"
      ) {
        ...
        if (angular.isDefined(item.field_mapping)) {
          _.each($scope.stages, function (stage, index) {
            ...
            _canvas.forEachObject(function (obj) {
              if (
                angular.isDefined(obj.field_mapping) &&
                item.field_mapping == obj.field_mapping
              ) {
                obj.text = item.text;
              }
            });
    ...
    $scope.checkCharacter = function (object) {
      ...
      opentype.load(font_url, function (err, font) {
        if (err) {
          ...
          var _index = _.findIndex(
            $scope.stages[$scope.currentStage].states.lostCharLayers,
            function (layerId) {
          ...
          if (!check) {
            ...
            if (_index == -1)
              $scope.stages[$scope.currentStage].states.lostCharLayers.push(
                itemId
              );
          } else {
            delete object.lostChar;
            if (_index > -1)
              $scope.stages[$scope.currentStage].states.lostCharLayers.splice(
                _index,
                1
              );
          }
    ...
    $scope.canAddMoreLayer = function () {
      $check = true;
      if (
        $scope.settings.nbdesigner_prevent_add_more_layer == "yes" &&
        !$scope.isTemplateMode
      )
        $check = false;
      return $check;
    ...
    $scope.canDeleteLayer = function () {
      $check = true;
      if (
        $scope.settings.nbdesigner_prevent_delete_template_layer == "yes" &&
        !$scope.isTemplateMode
      )
        $check = false;
      return $check;
    ...
    $scope.setPositionToolbox = function () {
      ...
      $timeout(function () {
        ...
        var $vista = jQuery(".nbd-vista"),
          ...
          $toolMain = jQuery(
            '.nbd-vista .v-toolbox .nbd-nav-tab[data-tab="tab-main-box"]'
          );
        ...
        var ratioScale =
          ...
          mBottom =
            (stage.config.cheight - stage.config.top - stage.config.height) *
            ratioScale,
          mRight =
            (stage.config.cwidth - stage.config.left - stage.config.width) *
            ratioScale,
        ...
        if ($stageMainActive.height() > $stageActive.height() - scrollXHeight) {
          if (
            $stageMainActive.height() - mBottom >
            $stageActive.outerHeight() + scrollTop - paddingT
          ) {
        ...
        if ($stageMainActive.width() > $stageActive.width() - scrollYWidth) {
          ...
          if (_boundLeft < 0) {
            pLeft =
              ($stageActive.outerWidth() - $stageMainActive.width()) / 2 +
              mLeft;
            transform = "translateX(0)";
    ...
    $scope.getCurrentLayerInfo = function () {
      ...
      if (objects.length > 1) {
        ...
        if (object) {
          ...
          $scope.stages[$scope.currentStage].states.ilr = angular.isDefined(
            object.get("ilr")
          )
            ? object.get("ilr")
            : false;
          $scope.stages[$scope.currentStage].states.forceLock =
            angular.isDefined(object.get("forceLock"))
              ? object.get("forceLock")
              : false;
          $scope.stages[$scope.currentStage].states.opacity =
            fabric.util.toFixed(object.get("opacity") * 100);
          [
            "type",
            "itemId",
            "lockMovementX",
          ...
          switch (object.type) {
            ...
            case "curvedText":
              ...
              $scope.stages[$scope.currentStage].states.fixedWidth =
                angular.isDefined(object.fixedWidth)
                  ? object.fixedWidth
                  : false;
              $scope.stages[$scope.currentStage].states.text = {
              ...
              if (
                ...
                $scope.stages[$scope.currentStage].states.text.ptFontSize = (
                  $scope.stages[$scope.currentStage].states.text.fontSize /
                  $scope.stages[$scope.currentStage].states.ratioConvertFont
                ).toFixed(2);
              }
              if (
                ...
                $scope.stages[
                  $scope.currentStage
                ].states.text.textBackgroundColor = "#ffffff";
              if (!$scope.stages[$scope.currentStage].states.text.stroke)
                $scope.stages[$scope.currentStage].states.text.stroke =
                  "#ffffff";
              if (object.type == "curvedText") {
                ...
                $scope.stages[$scope.currentStage].states.text.rtl =
                  angular.isDefined(object.rtl) ? object.rtl : false;
                if ($scope.stages[$scope.currentStage].states.text.rtl) {
                  $scope.stages[$scope.currentStage].states.text.text =
                    $scope.stages[$scope.currentStage].states.text.text
                      .split("")
                      .reverse()
                      .join("");
                ...
                $timeout(function () {
                  ...
                  if ($scope.settings.is_mobile)
                    jQuery(".main-toolbar").addClass("overflow-hidden");
                }, 300);
              } else {
                if ($scope.settings.is_mobile)
                  jQuery(".main-toolbar").removeClass("overflow-hidden");
              }
              $scope.stages[$scope.currentStage].states.enableRotate =
                NBDESIGNCONFIG.nbdesigner_text_rotate == "1" ? true : false;
              $scope.stages[$scope.currentStage].states.enableOpacity =
                NBDESIGNCONFIG.nbdesigner_text_opacity == "1" ? true : false;
              $scope.stages[$scope.currentStage].states.enableShadow =
                NBDESIGNCONFIG.nbdesigner_text_shadow == "1" &&
                NBDESIGNCONFIG.nbdesigner_enable_cloud2print_api == "yes"
                  ? true
                  : false;
              break;
            ...
            case "custom-image":
              $scope.stages[$scope.currentStage].states.elementUpload =
                angular.isDefined(object.get("elementUpload"))
                  ? object.get("elementUpload")
                  : false;
              $scope.stages[$scope.currentStage].states.ilr = angular.isDefined(
                object.get("ilr")
              )
              ...
              $scope.stages[$scope.currentStage].states.src =
                object.getSvgSrc();
              $scope.stages[$scope.currentStage].states.origin_src =
                angular.isDefined(object.origin_src)
                  ? object.origin_src
                  : object.getSvgSrc();
              if (angular.isDefined(object.origin_url)) {
                $scope.stages[$scope.currentStage].states.origin_url =
                  object.origin_url;
                $scope.stages[$scope.currentStage].states.origin_width =
                  object.origin_width;
                $scope.stages[$scope.currentStage].states.origin_height =
                  object.origin_height;
              } else {
              ...
              if ($scope.settings.enableImageFilter) {
                $scope.availableFilters.forEach(function (filter) {
                  $scope.stages[$scope.currentStage].states.filters[filter] =
                    $scope.checkActiveFilter(filter, object.filters);
                });
              }
              break;
            case "rect":
              ...
              if (NBDESIGNCONFIG.nbdesigner_clipart_change_path_color == "1") {
                $scope.stages[$scope.currentStage].states.geoObject = {
                  ...
                  strokeDashArray: object.get("strokeDashArray")
                    ? object.get("strokeDashArray")
                    : ["", ""],
                  strokeUniform: object.get("strokeUniform"),
                };
              }
              $scope.stages[$scope.currentStage].states.enableRotate =
                NBDESIGNCONFIG.nbdesigner_clipart_rotate == "1" ? true : false;
              $scope.stages[$scope.currentStage].states.enableOpacity =
                NBDESIGNCONFIG.nbdesigner_clipart_opacity == "1" ? true : false;
              break;
            case "path-group":
            case "path":
            case "group":
              ...
              if (NBDESIGNCONFIG.nbdesigner_clipart_change_path_color == "1") {
                $scope.stages[$scope.currentStage].states.svg.groupPath =
                  $scope.getPathOfSvg(object);
              } else {
                $scope.stages[$scope.currentStage].states.svg.groupPath = [];
              }
              if (object.type == "group")
                $scope.stages[$scope.currentStage].states.isNativeGroup = true;
              $scope.stages[$scope.currentStage].states.enableRotate =
                NBDESIGNCONFIG.nbdesigner_clipart_rotate == "1" ? true : false;
              $scope.stages[$scope.currentStage].states.enableOpacity =
                NBDESIGNCONFIG.nbdesigner_clipart_opacity == "1" ? true : false;
          ...
          if ($scope.stages[$scope.currentStage].states.enableShadow) {
            if (object.shadow) {
              ...
              $scope.stages[$scope.currentStage].states.shadow = angular.copy(
                $scope.defaultStageStates.shadow
              );
            }
          }
        }
    ...
    $scope.nextTip = function () {
      $scope.tips.current =
        $scope.tips.current == $scope.tips.total ? 1 : $scope.tips.current + 1;
    };
    ...
    $scope.getPathOfSvg = function (object) {
      ...
      if (groupPath.length == 0) {
        ...
        groupPath.push({
          color: tinycolor(object.get("stroke")).toHexString(),
          index: [-1],
        });
      }
      return groupPath;
    ...
    $scope.isUpperCase = function (object) {
      var _isUpperCase = angular.isDefined(object.is_uppercase)
        ? object.is_uppercase
        : false;
      return _isUpperCase;
    };
    ...
    $scope.insertTemplateFont = function (font_name, callback) {
      if (!_.filter($scope.resource.font.data, ["alias", font_name]).length) {
        NBDDataFactory.get(
          "nbd_get_resource",
          { type: "google_font", font_name: font_name },
          function (data) {
            data = JSON.parse(data);
            if (data.flag == 1) {
              if (
                !_.filter($scope.resource.font.data, ["alias", font_name])
                  .length
              ) {
              ...
              if (!jQuery("#" + font_id).length) {
                jQuery("head").append(
                  '<link id="' +
                    font_id +
                    '" href="https://fonts.googleapis.com/css?family=' +
                    fontName.replace(/\s/gi, "+") +
                    ':400,400i,700,700i" rel="stylesheet" type="text/css">'
                );
              }
              var font = new FontFaceObserver(fontName);
              font
                .load($scope.settings.subsets[data.data.subset]["preview_text"])
                .then(
                  function () {
              ...
              _.each(_font.file, function (file, index) {
                if (file != 0) {
                  ...
                  if (!(file.indexOf("http") > -1))
                    font_url = NBDESIGNCONFIG["font_url"] + file;
                  css += "@font-face {font-family: '" + fontName + "';";
                  css += "src: ";
                  css += "url('" + font_url + "') format('truetype');";
                  switch (index) {
        ...
        var font = new FontFaceObserver(fontName);
        font.load($scope.settings.subsets[_font.subset]["preview_text"]).then(
          function () {
            if (angular.isDefined(callback)) callback(fontName);
          },
          function () {
                      ...
                      $timeout(function () {
                        ...
                        if (index == $scope.stages.length - 1) {
                          ...
                          if (angular.isDefined(viewport)) {
                            ...
                            angular.isDefined(konfig) &&
                            angular.isDefined(konfig.scale)
                          ) {
                            viewport = {
            ...
            if (objects.length > 0) {
              ...
              if (type == "image" || type == "custom-image") {
                ...
                if (
                  ...
                  if (
                    !_.filter(stage.states.usedFonts, [
                      "alias",
                      item.fontFamily,
                    ]).length
                  ) {
                    stage.states.usedFonts.push(
                      $scope.getFontInfo(item.fontFamily)
                    );
                  }
                }
                [
                ...
                if (
                  angular.isDefined(item.field_mapping) &&
                  !$scope.isTemplateMode
                ) {
                  var field = _.filter($scope.settings.template_fields, {
                    key: item.field_mapping,
                  })[0];
                  if (angular.isDefined(field)) {
                    if (field.value != "") {
                      if (angular.isDefined(item.is_uppercase)) {
                        item.text = item.is_uppercase
                      ...
                      var mapping_field = _.filter(
                        $scope.templateHolderFields,
                        { key: item.field_mapping }
                      )[0];
                      if (angular.isUndefined(mapping_field)) {
                        $scope.templateHolderFields.push(
                    ...
                    if (mustInsert) {
                      if (type == "text") {
                        ...
                        klass.fromObject(item, function (item) {
                          ...
                          _canvas.add(item);
                          var maskLayer = _canvas.item(
                              _canvas.getObjects().length - 1
                            ),
                            maskId = maskLayer.get("itemId"),
                            defaultMaskImageUrl =
                              NBDESIGNCONFIG.assets_url +
                          ...
                          fabric.Image.fromURL(
                            ...
                            function (op) {
                              ...
                              if (!!maskLayer.get("forceLock"))
                                op.set({ lockMask: true });
                              _canvas.add(op);
                              continueLoadLayer();
                            },
        ...
        if (fonts.length) {
          _.each(fonts, function (font, index) {
            if (
              ...
              if (
                angular.isDefined(font.file) &&
                angular.isDefined(font.file.r)
              )
                $scope.resource.font.data.push(font);
            }
            if (index == fonts.length - 1) {
              $scope.insertTemplateFont(font.alias, function () {
                loadStage(stageIndex);
                if (
                  !_.filter($scope.resource.usedFonts, ["alias", font.alias])
                    .length
                ) {
                  $scope.resource.usedFonts.push(
                    $scope.getFontInfo(font.alias)
                  );
                }
              });
            } else {
    ...
    $scope.boostInsertTemplate = function (local, temp) {
      ...
      async function loadPhotoFrameFromObject(klass, object) {
        ...
        let maskId = item.itemId,
          defaultMaskImageUrl =
            NBDESIGNCONFIG.assets_url + "images/placeholder.png";
      ...
      function loadDesign(fonts, design, viewport, konfig) {
        async function loadStages() {
            ...
            if (type == "image" || type == "custom-image") {
              ...
              if (
                ...
                if (
                  ...
                  stage.states.usedFonts.push(
                    $scope.getFontInfo(object.fontFamily)
                  );
                }
              }
              if (
                angular.isDefined(object.field_mapping) &&
                !$scope.isTemplateMode
              ) {
                var field = _.filter($scope.settings.template_fields, {
                  key: object.field_mapping,
                })[0];
                if (angular.isDefined(field)) {
                  if (field.value != "") {
                    if (angular.isDefined(object.is_uppercase)) {
                      object.text = object.is_uppercase
                        ? field.value.toUpperCase()
                        : field.value.toLowerCase();
                    } else {
                    ...
                    var mapping_field = _.filter($scope.templateHolderFields, {
                      key: object.field_mapping,
                    })[0];
                    if (angular.isUndefined(mapping_field)) {
                      $scope.templateHolderFields.push(
              ...
              if (
                angular.isDefined(object.v_card) &&
                !$scope.isTemplateMode &&
                $scope.settings.is_logged == "1"
              ) {
          ...
          async function loadStage(stageIndex) {
            ...
            photoHolders.map((photoHolder) => {
              ...
              layers.map((layer, layerIndex) => {
                if (photoHolder.itemId == layer.itemId)
                  holderIndex = layerIndex;
              });
          ...
          await Promise.all(
            $scope.stages.map(async (stage, stageIndex) => {
    ...
    $scope.closePopupInertPartTem = function () {
      jQuery(".insert-part-template-alert .close-popup").triggerHandler(
        "click"
      );
    };
                    ...
                    klass.fromObject(item, function (item) {
                      ...
                      fabric.Image.fromURL(
                        ...
                        function (op) {
                          ...
                          var d = new Date(),
                            itemId =
                              d.getTime() + Math.floor(Math.random() * 1000);
                          op.set({
                            clipPath: maskLayer,
                            perPixelTargetFind: true,
                            centeredScaling: true,
        ...
        if (fonts.length) {
          _.each(fonts, function (font, index) {
            ...
            if (index == fonts.length - 1) {
              $scope.insertTemplateFont(font.alias, function () {
                if (
                  $scope.settings.nbdesigner_boosting_load_template == "yes"
                ) {
                  boostLoadLayer();
                } else {
                  loadStage();
    ...
    $scope.resizeStage = function (viewport, stage_id, wihoutLoading) {
      var stage = angular.isDefined(stage_id)
        ? $scope.stages[stage_id]
      ...
      if (factor != 1) {
        stage.canvas.forEachObject(function (obj) {
          ...
          if (
            obj.clipPath &&
            obj.clipPath.absolutePositioned & !obj.clipPath._isTemMask
          ) {
    ...
    $scope.insertTypography = function (typo) {
      ...
      NBDDataFactory.get(
        "nbd_get_resource",
        { type: "get_typo", folder: typo.folder },
        function (data) {
          data = JSON.parse(data);
                  ...
                  $scope.renderTextAfterLoadFont(
                    ...
                    function () {
                      ...
                      if (selection.width * scale > _canvas.width * 0.8) {
                        ...
                        selection.scaleX =
                          (selection.scaleX * canvasWidth * 0.8) /
                          (selection.width * scale);
                        selection.scaleY =
                          (selection.scaleY * canvasWidth * 0.8) /
                          (selection.width * scale);
                        selection.width =
                          (selection.width * canvasWidth * 0.8) /
                          (selection.width * scale);
                        selection.addWithUpdate();
                        if (selection.height * scale > _canvas.height * 0.8) {
                          var canvasHeight = _canvas.height;
                          selection.scaleX =
                            (selection.scaleX * canvasHeight * 0.8) /
                            (selection.height * scale);
                          selection.scaleY =
                            (selection.scaleY * canvasHeight * 0.8) /
                            (selection.height * scale);
                          selection.height =
                            (selection.height * canvasHeight * 0.8) /
                            (selection.height * scale);
                          selection.addWithUpdate();
                        }
                      }
          ...
          if (fonts.length) {
            _.each(fonts, function (font, index) {
              if (
                !_.filter($scope.resource.font.data, ["alias", font.alias])
                  .length
              ) {
                $scope.resource.font.data.push(font);
              }
              if (index == fonts.length - 1) {
                $scope.insertTemplateFont(font.alias, function () {
                  loadLayers();
                  if (
                    !_.filter(stage.states.usedFonts, ["alias", font.alias])
                      .length
                  ) {
    ...
    $scope.renderTextAfterLoadFont = function (layers, callback) {
      ...
      _.each(layers, function (item, index) {
        if (
          ["text", "i-text", "curvedText", "textbox"].indexOf(item.type) > -1
        ) {
      ...
      fabric.Image.fromURL(
        ...
        function (op) {
          ...
          fabric.loadSVGFromURL(svg_url, function (ob, op) {
            _canvas.add(
              fabric.util.groupSVGElements(ob, op).set({
            ...
            $timeout(function () {
              ...
              _.each(textIndexArr, function (el, index) {
                ...
                if (el.type == "text") {
                  ...
                  if (
                    index <
                    _.findLastIndex(textIndexArr, function (o) {
                      return o.type == "text";
                    })
                  ) {
                    $scope.insertTemplateFont(el.font, function (fontName) {
                      ...
                      _canvas.add(_text);
                      if (
                        !_.filter(_stages.states.usedFonts, ["alias", fontName])
                          .length
                      ) {
                        _stages.states.usedFonts.push(
                          $scope.getFontInfo(fontName)
                        );
                      }
                    });
                  } else {
      ...
      if (_stage.undos.length > 1) {
        ...
        if ($scope.resource.shareDesign) {
          if (NBDESIGNCONFIG["ui_mode"] == 1) {
            nbd_window
              .jQuery(nbd_window.document)
              .triggerHandler("nbd_pass_design_json", {
                stage_id: this.currentStage,
                design: nexttoLast,
                config: {
                  width: _canvas.width,
                  height: _canvas.height,
                  zoom: _stage.states.scaleRange[
                    _stage.states.currentScaleIndex
                  ].ratio,
                },
            ...
            jQuery(document).triggerHandler("nbd_pass_design_json", {
              ...
              config: {
                width: _canvas.width,
                height: _canvas.height,
                zoom: _stage.states.scaleRange[_stage.states.currentScaleIndex]
                  .ratio,
              },
              fonts: _stage.states.usedFonts,
            });
    ...
    $scope._loadStageFromJson = function (
      stage_id,
      json,
      callback,
      withoutLoading
    ...
    $scope.toggleStageFullScreenMode = function () {
      _.each($scope.stages, function (stage, index) {
        var zoomIndex = $scope.fullScreenMode
          ? stage.states.fullScreenScaleIndex
          : stage.states.fitScaleIndex;
    ...
    $scope.addGeometricalObject = function (type) {
      ...
      switch (type) {
        ...
        case "hexagon":
          ...
          break;
        case "line":
          object = new fabric.Line([0, 20, 100, 20], {
    ...
    $scope.unGroupLayers = function () {
      ...
      if (activeObject.type === "group") {
        ...
        if (angular.isDefined(activeObject.itemId)) {
          $scope.onUnloadGroup.prevIndex = $scope.getLayerById(
            activeObject.itemId
          );
        }
        $scope.contextAddLayers = "template";
    ...
    $scope.changeBush = function (color) {
      ...
      _.each($scope.stages, function (stage, index) {
        stage.canvas.freeDrawingBrush = new fabric[
          $scope.resource.drawMode.brushType + "Brush"
        ](stage.canvas);
        stage.canvas.freeDrawingBrush.color =
          $scope.resource.drawMode.brushColor;
        stage.canvas.freeDrawingBrush.width =
          $scope.resource.drawMode.brushWidth;
      });
    };
        ...
        if (this.files.length > 0) {
          ...
          reader.onload = function (event) {
            if (event.target.readyState === 2) {
              ...
              $scope.importImages(
                result,
                function (new_design, fonts, extenalDesign) {
                  var temp = {
                    fonts: fonts,
                    design: new_design,
    ...
    $scope.importImages = function (result, callback) {
      ...
      _.each(design, function (side, sideIndex) {
        ...
        _.each(objects, function (object, objectIndex) {
          ...
          if (type == "image" || type == "custom-image") {
            if (
              src.indexOf($scope.settings.home_url) == -1 &&
              src.indexOf("data:im") == -1
            ) {
    ...
    $scope.loadMyDesign = function (did, inCart) {
      function process() {
        ...
        $scope.toggleStageLoading();
        var popup = inCart
          ? ".popup-nbd-my-designs-in-cart"
          : ".popup-nbd-my-templates";
        if (did != null) {
          dataObj = { did: did };
        ...
        var action = inCart
          ? "nbd_get_designs_in_cart"
          : "nbd_get_user_designs";
        NBDDataFactory.get(action, dataObj, function (data) {
          data = JSON.parse(data);
          if (data.flag == 1) {
    ...
    $scope.storeLayers = function () {
      ...
      if (item) {
        ...
        $scope.tempCanvas.setDimensions({
          width: bound.width,
          height: bound.height,
        });
        ...
        function importLayerToTempCanvas(currentIndex) {
          ...
          function continueLoadLayer() {
            var _item = $scope.tempCanvas.item(
              $scope.tempCanvas.getObjects().length - 1
            );
            ...
            if (currentIndex <= layers.length - 1) {
              ...
              $timeout(function () {
                ...
                designData.design = $scope.tempCanvas.toJSON(
                  $scope.includeExport
                );
                var designObj = {
                ...
                var _dataObj = {
                  ...
                  design: new Blob([JSON.stringify(designObj)], {
                    type: "application/json",
                  }),
      ...
      function loadLayer(_index) {
        if (_index == layers.length) {
          ...
          $timeout(function () {
            ...
            jQuery(".popup-nbd-user-design .overlay-main").removeClass(
              "active"
            );
          }, 50);
        } else {
          ...
          if (type == "image" || type == "custom-image") {
            ...
            klass.fromObject(object, function (object) {
              if (
                ["i-text", "text", "textbox", "curvedText"].indexOf(
                  object.type
                ) > -1
              ) {
        ...
        _.each(fonts, function (font, index) {
          ...
          if (index == fonts.length - 1) {
            $scope.insertTemplateFont(font.alias, function () {
              loadLayer(_index);
              if (
                !_.filter(stage.states.usedFonts, ["alias", font.alias]).length
              ) {
                stage.states.usedFonts.push($scope.getFontInfo(font.alias));
              }
            });
    ...
    $scope.activeLayer = function (itemIndex, layerIndex) {
      ...
      if (
        !$scope.isTemplateMode &&
        angular.isDefined(_canvas.item(itemIndex).forceLock) &&
        _canvas.item(itemIndex).forceLock
      )
        return;
      _canvas.setActiveObject(_canvas.item(itemIndex));
      if (angular.isDefined(layerIndex))
        _stage.layers[layerIndex].active = true;
      $scope.renderStage();
    };
    ...
    $scope.alignLayer = function (command) {
      ...
      items.forEach(function (item, index) {
        ...
        if (bound.left + bound.width > position.right)
          position.right = bound.left + bound.width;
        if (bound.top + bound.height > position.bottom)
          position.bottom = bound.top + bound.height;
      ...
      switch (command) {
        ...
        case "right":
          items.forEach(function (item) {
            ...
            item.set({
              left:
                item.get("left") - bound.left + position.right - bound.width,
            });
            item.setCoords();
          });
          break;
        case "dis-horizontal":
          var leftPosition = _.sortBy(_leftPosition, [
            function (o) {
              return o.value;
            },
          ]);
          var space =
            (position.right - position.left - totalWidth) / (items.length - 1);
            ...
            if (_index > 0 && _index < items.length - 1) {
              ...
              item.set({
                left:
                  item.get("left") -
                  bound.left +
                  previous_item_bound.left +
                  previous_item_bound.width +
                  space,
              });
              item.setCoords();
            }
          ...
          break;
        case "dis-vertical":
          var topPosition = _.sortBy(_topPosition, [
            function (o) {
              return o.value;
            },
          ]);
          var space =
            (position.bottom - position.top - totalHeight) / (items.length - 1);
            ...
            if (_index > 0 && _index < items.length - 1) {
              ...
              item.set({
                top:
                  item.get("top") -
                  bound.top +
                  previous_item_bound.top +
                  previous_item_bound.height +
                  space,
              });
              item.setCoords();
            }
    ...
    $scope.translateLayer = function (command) {
      ...
      switch (command) {
        ...
        case "top":
          ...
          break;
        case "top-left":
          var _top = top - bound.top / scale,
            _left = left - bound.left / scale;
          if (originX == "center") {
    ...
    $scope.zoomStage = function (index, stage_id) {
      ...
      jQuery("#stage-container-" + $scope.currentStage)
        .stop()
        .animate(
          {
            scrollTop: 0,
      ...
      jQuery("#stage-container-" + $scope.currentStage).perfectScrollbar(
        "update"
      );
    ...
    $scope.confirmClearStage = function () {
      if (!$scope.canDeleteLayer()) return;
      jQuery(
        ".nbd-popup.clear-stage-alert, .v-popup.v-popup-select"
      ).nbShowPopup();
    };
    ...
    $scope.pasteStage = function (dist_stage) {
      dist_stage = angular.isDefined(dist_stage)
        ? dist_stage
        : $scope.currentStage;
    ...
    $scope.duplicateStage = function (stage_id) {
      ...
      $timeout(function () {
        $scope.loadStageFromJson(
          stage_id * 1 + 1,
          $scope.tempStageDesign.design
        );
      }, 100);
    };
    ...
    $scope._addStage = function (stage_id) {
      ...
      angular.copy(
        $scope.settings.product_data.product[stage_id],
        new_product_stage
      );
      $scope.settings.product_data.product.splice(
        stage_id * 1 + 1,
    ...
    $scope.swapStage = function (dst_id, src_id, callback) {
      ...
      angular.copy(
        $scope.settings.product_data.product[dst_id],
        dst_product_stage
      );
      angular.copy(
        $scope.settings.product_data.product[src_id],
        src_product_stage
      );
    ...
    $scope.moveStage = function (from, to, callback) {
      ...
      angular.copy(
        $scope.settings.product_data.product[from],
        from_product_stage
      );
      ...
      $timeout(function () {
        $scope._loadStageFromJson(
          ...
          function () {
            ...
            $scope.updateApp();
            jQuery(".popup-nbd-stage-grid-view .overlay-main").removeClass(
              "active"
            );
            if (typeof callback == "function") {
              callback();
      ...
      _canvas.forEachObject(function (obj, index) {
        if (!!obj.get("isMask")) {
          var id = obj.get("itemId"),
            check = true;
          if (
            angular.isDefined(selectedItem) &&
            selectedItem.get("itemId") == id
          ) {
            check = false;
          }
      ...
      _canvas.forEachObject(function (obj, index) {
        ...
        if (!obj.isAlwaysOnTop) {
          if (!obj.get("isMask")) {
            ...
            layerInfo.layerName =
              typeof obj.layerName != "undefined"
                ? obj.layerName
                : angular.isDefined($scope.settings.nbdlangs[layerInfo.type])
                ? $scope.settings.nbdlangs[layerInfo.type]
                : "";
    ...
    $scope.getBackgroundImgList = function () {
      $scope.resource.background = angular.isDefined(
        $scope.settings.backgroundList
      )
        ? $scope.settings.backgroundList
        : [];
    ...
    $scope.loadMoreBackgroundImgList = function () {
      if ($scope.backgroundImgLitmit < $scope.resource.background.length)
        $scope.backgroundImgLitmit += 24;
    };
    ...
    $scope.selectCombinationColor = function ($index) {
      var bgColor =
          $scope.settings.nbes_settings.combination_colors.bg_codes[$index],
        fgColor =
          $scope.settings.nbes_settings.combination_colors.fg_codes[$index];
    ...
    $scope.forceForeground = function (item) {
      if (
        ...
        if (
          $scope.settings.nbes_enable_settings.combination == 1 &&
          angular.isDefined($scope.settings.nbes_settings.combination_colors) &&
          $scope.settings.nbes_settings.combination_colors.fg_codes.length > 0
        ) {
          foreFill = true;
          color =
            $scope.settings.nbes_settings.combination_colors.fg_codes[
              $scope.currentCombinationColor
            ];
        } else if (
          $scope.settings.nbes_enable_settings.foreground == 1 &&
          $scope.settings.nbes_settings.force_fg == 1 &&
          angular.isDefined($scope.settings.nbes_settings.foreground_colors) &&
          $scope.settings.nbes_settings.foreground_colors.codes.length > 0
        ) {
          foreFill = true;
          color =
            $scope.settings.nbes_settings.foreground_colors.codes[
              $scope.currentForegroundColor
            ];
        }
        if (foreFill) {
          switch (item.type) {
    ...
    $scope.changeFill = function (color) {
      ...
      if (!_stage.states.isPath) {
        ...
        if ($scope.stages[$scope.currentStage].states.isShape) {
          _stage.states.svg.groupPath[_stage.states.svg.currentPath].color =
            color;
        }
      } else {
        item.set({ dirty: true });
        _.each(
          _stage.states.svg.groupPath[_stage.states.svg.currentPath].index,
          function (path_index) {
            if (path_index == -2) {
              item.set({ fill: color });
            } else {
      ...
      if (
        ...
        var index =
          $scope.settings.nbes_settings.foreground_colors.codes.indexOf(color);
    ...
    $scope.initEyeDropper = function ($event, global) {
      ...
      var setEyeDropper = function () {
        ...
        jQuery(".nbd-eyedropper-wrap")
          .off("mousemove")
          .on("mousemove", function (evt) {
            var infoLeft =
                evt.clientX -
                (evt.clientX + 100 >= window.innerWidth ? 90 : -5),
              infoTop = evt.clientY - (evt.clientY - 15 <= 0 ? -20 : 25),
              data = $scope.eyedropper.getImageData(
                evt.clientX,
                evt.clientY + 21,
                1,
                1
        ...
        jQuery(".nbd-eyedropper-wrap")
          ...
          .on("mousedown", function (evt) {
            ...
            var data = $scope.eyedropper.getImageData(
                evt.clientX,
                evt.clientY + 21,
                1,
                1
    ...
    $scope.initEyeDropper2 = function ($event, global) {
      var _stage = $scope.stages[$scope.currentStage],
        ...
        canvasEl = jQuery(
          "#stage-container-" + $scope.currentStage + " .lower-canvas"
        ),
      ...
      jQuery(".nbd-eyedropper-wrap").addClass("active");
      jQuery(".nbd-eyedropper-inner-wrap")
        .off("mouseenter")
      ...
      jQuery(".nbd-eyedropper-inner-wrap")
        ...
        .on("mousemove", function (evt) {
          var infoLeft =
              evt.clientX - (evt.clientX + 100 >= window.innerWidth ? 90 : -5),
            infoTop = evt.clientY - (evt.clientY - 15 <= 0 ? -20 : 25),
          ...
          if (
            canvasLeft > 0 &&
            canvasTop > 0 &&
            canvasLeft <= _canvas.width &&
            canvasTop <= _canvas.height
          ) {
    ...
    $scope.addCurvedText = function (content) {
      ...
      font
        .load(
          $scope.settings.subsets[NBDESIGNCONFIG.default_font.subset][
            "preview_text"
          ]
        )
        .then(
    ...
    $scope.setLayerAttribute = function (type, value, item_index, layer_index) {
      ...
      var item = angular.isDefined(item_index)
        ? _canvas.item(item_index)
        : _canvas.getActiveObject();
      if (!item) return;
      if (
        type == "selectable" &&
        !$scope.isTemplateMode &&
        angular.isDefined(item.forceLock) &&
        item.forceLock
      )
        return;
      $scope.beforeObjectModify(item);
      ...
      if (
        (itemType == "i-text" || itemType == "textbox") &&
        type == "forceLock"
      ) {
        value == true
    ...
    $scope.setTextAttribute = function (type, value, extra_option) {
      ...
      switch (type) {
        case "is_uppercase":
          value
            ? item.set({ text: item.get("text").toUpperCase() })
            : item.set({ text: item.get("text").toLowerCase() });
          break;
        case "fontFamily":
    ...
    $scope.setShadow = function () {
      ...
      if (!item) return;
      $scope.beforeObjectModify(item);
      var colorArr = fabric.Color.sourceFromHex(
          $scope.stages[$scope.currentStage].states.shadow.color
        ),
        color = `rgba(${colorArr[0]},${colorArr[1]},${colorArr[2]},${
          $scope.stages[$scope.currentStage].states.shadow.opacity
        })`;
      item.set({
        shadow: {
          color: color,
    ...
    $scope.addImageFromUrl = function (dataImg, extenal, ilr, maskId) {
      ...
      if (angular.isUndefined(extenal) || extenal) {
        NBDDataFactory.get(
          ...
          { url: url, gapi: $scope.resource.gapi },
          function (data) {
            data = JSON.parse(data);
            if (data["flag"] == 1) {
              if (angular.isDefined(maskId)) {
    ...
    $scope.addImage = function (
      ...
      var stage = $scope.stages[$scope.currentStage],
        ...
        url =
          typeof data == "object"
            ? angular.isDefined(data.src)
              ? data.src
              : data.url
            : data;
      if (showLoading) $scope.toggleStageLoading();
      if (
        angular.isUndefined(maskId) &&
        !$scope.isTemplateMode &&
        $scope.settings.nbdesigner_auto_fill_template_masks == "yes"
      ) {
      ...
      if (
        angular.isUndefined(maskId) &&
        !$scope.isTemplateMode &&
        $scope.settings.nbdesigner_limit_photo_by_masks == "yes"
      ) {
        if (hideLoading) {
          $timeout(function () {
            $scope.toggleStageLoading();
    ...
    $scope.getPathCommand = function () {
      var svgStr = $scope.svgPath
        ...
        .replace(/ $/g, "")
        .replace(
          /(?:class|id|style|xmlns\:xlink|xml\:space|fill|enable-background)=['\"][^'\"]*['\"]/g,
          ""
        )
        .replace(/<\/?g>/g, "")
        .replace(/\s{2,}/g, " ")
    ...
    $scope.createClippingMask = function (maskIndex, obj) {
      ...
      if (obj) {
        ...
        var pathCommand =
          maskIndex > -1 ? $scope.masks[maskIndex] : $scope.pathCommand;
    ...
    $scope.removeClippingMask = function (
      obj,
      needreRender,
      withoutRemoveMask
    ) {
    ...
    $scope.bgRemoveObj = { status: false };
    $scope.initBackgroundRemove = function () {
        $scope.bgRemoveObj.status = true;
        jQuery(".nbd-popup.popup-nbd-bg-remove").nbShowPopup();
        $scope.bgRemoveObj.src = $scope.stages[$scope.currentStage].states.origin_src;
        jQuery(".nbd-popup.popup-nbd-bg-remove .overlay-popup").addClass("nbo-disable");

        var img = new Image();
        img.src = $scope.bgRemoveObj.src;
        img.onload = function () {
            $timeout(function () {
                $scope.bgRemoveObj.canvas = new FabricWindow.Canvas("bg-remove-handle-wrap");
                var width = jQuery("#bg-remove-source").width(),
                    height = jQuery("#bg-remove-source").height();
                $scope.bgRemoveObj.canvas.setDimensions({ width: width, height: height });

                fabric.Image.fromURL($scope.bgRemoveObj.src, function (img) {
                    img.scaleToWidth(width);
                    img.scaleToHeight(height);
                    $scope.bgRemoveObj.canvas.add(img);
                }, { crossOrigin: "anonymous" });
    ...
    $scope.removeBackground = function () {
      ...
      fd.append("action", "nbd_remove_bg");
      fd.append("url", $scope.bgRemoveObj.src);
  
      jQuery(".nbd-popup.popup-nbd-bg-remove").find(".overlay-main").addClass("active");
      ...
      jQuery.ajax({
          ...
          if (data.flag == 1) {
              fabric.Image.fromURL(data.url, function (img) {
                  var stage = $scope.stages[$scope.currentStage],
                      _canvas = stage["canvas"];
                  $scope.beforeObjectModify(_canvas);
                  img.scaleToWidth(_canvas.width);
                  img.scaleToHeight(_canvas.height);
                  _canvas.clear();
                  _canvas.add(img);
                  $scope.renderStage();
              }, { crossOrigin: "anonymous" });
          }
          jQuery(".nbd-popup.popup-nbd-bg-remove").find(".overlay-main").removeClass("active");
      });
  };
    ...
    $scope.initCrop = function () {
      ...
      $scope.cropObj.origin_url =
        $scope.stages[$scope.currentStage].states.origin_url;
      jQuery(".nbd-popup.popup-nbd-crop .overlay-popup").addClass(
        "nbo-disable"
      );
      jQuery(".nbd-popup.popup-nbd-crop")
        .find(".overlay-main")
        .removeClass("active");
      var img = new Image();
      ...
      img.onload = function () {
        ...
        $timeout(function () {
          $scope.cropObj.canvas = $scope.cropObj.canvas
            ? $scope.cropObj.canvas
            : new FabricWindow.Canvas("crop-handle-wrap");
          ...
          $scope.cropObj.canvas.on("object:modified", function (options) {
            ...
            if (
              ...
              $scope.cropObj.canvas.getWidth()
            ) {
              obj.scaleX =
                obj.scaleX *
                (($scope.cropObj.canvas.getWidth() - left) /
                  boundingRect.width);
            }
            if (
              boundingRect.top + boundingRect.height >
              $scope.cropObj.canvas.getHeight()
            ) {
              obj.scaleY =
                obj.scaleY *
                (($scope.cropObj.canvas.getHeight() - top) /
                  boundingRect.height);
            }
            obj.setCoords();
          });
          ...
          if (
            angular.isDefined(
              $scope.stages[$scope.currentStage].states.crop_left
            )
          ) {
            rect.set({
        ...
        fabric.Image.fromURL(
          ...
          function (op) {
            ...
            jQuery(".nbd-popup.popup-nbd-crop")
              .find(".overlay-main")
              .removeClass("active");
            jQuery(".nbd-popup.popup-nbd-crop .close-popup").triggerHandler(
              "click"
            );
          },
          { crossOrigin: "anonymous" }
    ...
    $scope.addMask = function (shapeIndex) {
      var stage = $scope.stages[$scope.currentStage],
        _canvas = stage["canvas"],
        scale = stage.states.scaleRange[stage.states.currentScaleIndex].ratio,
        max_width = (_canvas.width / scale) * 0.3,
        max_height = (_canvas.height / scale) * 0.3,
        new_width = max_width;
      var pathCommand =
        shapeIndex > -1 ? $scope.masks[shapeIndex] : $scope.pathCommand;
      if (pathCommand == "") return;
    ...
    $scope.addPhotoFrame = function (frame) {
      var url =
          "//dpeuzbvf3y4lr.cloudfront.net/frames/svg/s" + (frame + 1) + ".svg",
    ...
    $scope.addFrame = function (frame) {
      ...
      var totalWidth = colWidths.reduce(
        (accumulator, currentValue, currentIndex, array) => {
          return accumulator + currentValue;
        }
      );
      var totalHeight = rowHeights.reduce(
        (accumulator, currentValue, currentIndex, array) => {
          return accumulator + currentValue;
        }
      );
      ...
      angular.forEach(panels, function (panel, key) {
        ...
        path.set({
          ...
          scaleX:
            (panel.colWidth * cellWidth + (panel.colWidth - 1) * gap) /
            path.get("width"),
          scaleY:
            (panel.rowHeight * cellHeight + (panel.rowHeight - 1) * gap) /
            path.get("height"),
          isMask: 1,
          itemId: itemId,
          absolutePositioned: true,
    ...
    $scope.addSvgFromMedia = function (art, $index) {
      ...
      $http({
        ...
        url:
          appConfig.mediaUrl +
          "/clipart?get_svg=" +
          art.url.replace("//dpeuzbvf3y4lr.cloudfront.net/", ""),
      }).then(
        function successCallback(response) {
    ...
    $scope._addSvg = function (ob, op, art, hideLoading) {
      var stage = $scope.stages[$scope.currentStage],
        _canvas = stage["canvas"],
        scale = stage.states.scaleRange[stage.states.currentScaleIndex].ratio,
        max_width = (_canvas.width / scale) * 0.9,
        max_height = (_canvas.height / scale) * 0.9,
        new_width = max_width;
    ...
    $scope.addQrCode = function () {
      ...
      fabric.loadSVGFromString(_qrcode, function (ob, op) {
        $scope._addSvg(
          ob,
          op,
          { name: "", type: "qrcode", qrContent: $scope.resource.qrText },
          false
        );
      });
      jQuery("#barcode").html("");
    ...
    $scope.addBarCode = function () {
      ...
      $timeout(function () {
        fabric.loadSVGFromString(
          jQuery("#barcode").wrap("<div/>").parent().html(),
          function (ob, op) {
            $scope._addSvg(
              ob,
              op,
              {
                name: "",
                barCodeContent: $scope.resource.qrText,
                type: "barcode",
              },
              false
            );
    ...
    $scope.startTourGuide = function () {
      ...
      if ($scope.tourGuide.currentStep == -1) {
        ...
        $scope.tourGuide.steps = _.sortBy(steps, [
          function (s) {
            return s.priority;
          },
        ]);
    ...
    $scope.processTourComponents = function (close) {
      var targetEl =
        $scope.tourGuide.steps[$scope.tourGuide.currentStep].element;
      if (close) {
    ...
    $scope.updateMapUrl = function () {
      if ($scope.resource.maps.address != "") {
        ...
        $scope.resource.maps.url +=
          "&maptype=" +
          $scope.resource.maps.maptype +
          "&format=jpg&markers=size:" +
          $scope.resource.maps.markers.size;
        $scope.resource.maps.url +=
          "|color:0x" +
          $scope.resource.maps.markers.color.replace("#", "") +
          "|label:" +
          $scope.resource.maps.markers.label +
          "|" +
          address +
          "&key=" +
          $scope.settings.nbdesigner_static_map_api_key +
          "&.jpg";
        ...
        img.onload = function () {
          ...
          jQuery("#tab-element .tab-scroll").animate(
            { scrollTop: jQuery("#tab-element .tab-scroll").height() },
            300
          );
        };
    ...
    $scope.show3DPreview = function () {
      ...
      function _show3DPreview() {
        if (!$scope.threeDimensionPreview.existedFrame) {
          var iframe_src =
            NBDESIGNCONFIG.home_url +
            "?nbd-route=nbd-3d-preview&product_id=" +
            NBDESIGNCONFIG.product_id;
          jQuery(".preview-3d-wrap-inner").prepend(
            '<iframe id="preview-3d-wrap"  width="100%" height="100%" scrolling="no" frameborder="0" noresize="noresize" allowfullscreen mozallowfullscreen="true" webkitallowfullscreen="true" src="' +
              iframe_src +
              '"></iframe>'
          );
    ...
    $scope.generateStickerCutline = function (onSaveDesign) {
      ...
      var _stage = $scope.stages[0],
        ...
        bleedTB =
          _stage.states.scaleRange[_stage.states.currentScaleIndex].ratio *
          _stage.config.bleed_tb,
        bleedLR =
          _stage.states.scaleRange[_stage.states.currentScaleIndex].ratio *
          _stage.config.bleed_lr,
      ...
      function buildCutlineSvg() {
        ...
        jQuery(".sticker-contour-wrap")
          .html("")
          .append($scope.stickerCutline.svg);

        if (
          angular.isDefined($scope.settings.product_data.product[0].pattern)
        ) {
          var pattern = $scope.settings.product_data.product[0].pattern;

          $scope.stickerCutline.patternSvg =
            '<svg version="1.1" width="' +
            width +
            '" height="' +
            height +
          ...
          if (pattern.type == "image") {
            var patternWidth = 100,
              patternHeight = 100;
            $scope.stickerCutline.patternSvg +=
              '<pattern id="sticker_material_pattern" x="0" y="0" width="' +
              patternWidth / width +
              '" height="' +
              patternHeight / width +
              '" ><image x="0px" y="0px" width="' +
              patternWidth +
              '" height="' +
              patternHeight +
              '" xlink:href="' +
          ...
          if (pattern.type == "color") {
            $scope.stickerCutline.patternSvg +=
              '" stroke-width="0" fill="' + options.color + '" />';
          } else {
            $scope.stickerCutline.patternSvg +=
              '" stroke-width="0" fill="url(#sticker_material_pattern)" />';
          }
          $scope.stickerCutline.patternSvg += "</svg>";

          jQuery(".sticker-contour-pattern-wrap")
            .html("")
            .append($scope.stickerCutline.patternSvg);
        }
...
function buildSvgFilter(jOptions, _in) {
  ...
  switch (options.type) {
    ...
    case "desaturate":
      filter +=
        '<feColorMatrix type="saturate" in="' +
        _in +
        '" values="0" result="' +
        options.type +
        '"/>';
    ...
    case "contrast":
      ...
      filter +=
        '<feComponentTransfer in="' + _in + '" result="' + options.type + '">';
      filter +=
    ...
    case "sepiatone":
      filter +=
        '<feColorMatrix type="matrix" in="' +
        _in +
        '" values=".343 .669 .119 0 0 .249 .626 .130 0 0 .172 .334 .111 0 0 .000 .000 .000 1 0" result="' +
        options.type +
        '"/>';
      break;
    case "hue":
    ...
    case "luminance":
      filter +=
        '<feColorMatrix type="luminanceToAlpha" in="' +
        _in +
        '" result="' +
        options.type +
        '"/>';
    ...
    case "colorize":
      filter +=
        '<feColorMatrix type="matrix" in="' +
        _in +
        '" values="1.0 0 0 0 0 0 0.2 0 0 0 0 0 0.2 0 0 0 0 0 1.0 0" result="' +
        options.type +
        '"/>';
      break;
    case "posterize":
...
nbdApp.factory("FabricWindow", [
  ...
  function ($window) {
    ...
    fabric.Canvas2dFilterBackend.prototype.applyFilters = async function (
      filters,
      sourceElement,
      sourceWidth,
      sourceHeight,
        ...
        return new Promise(function (resolve, reject) {
          function buildSvg() {
            ...
            svg +=
              '<image xlink:href="' +
              originUrl +
              '" x="0" y="0" width="100%" height="100%" filter="url(#' +
              id +
              ')"></image>';
            svg += "</svg>";
    ...
    fabric.Image.filters.CustomFilter.fromObject =
    ...
    if (NBDESIGNCONFIG.nbdesigner_enable_font_to_outlines == "yes") {
      fabric.Text.prototype._createTextCharSpan = function (
        ...
        if ($window.outlineFonts[fontName]) {
          var path = $window.outlineFonts[fontName].getPath(
  ...
  function (FabricWindow, $timeout, $rootScope) {
    return {
      ...
      link: function (scope, element, attrs) {
        $timeout(function () {
          scope.stage.canvas = new FabricWindow.Canvas(
            "nbd-stage-" + scope.index
          );
    ...
    return {
      ...
      link: function (scope, element, attrs) {
        $timeout(function () {
          var el =
              scope.type != "font"
                ? jQuery(scope.container + " .tab-scroll")
                : jQuery(scope.container),
            offset = parseInt(scope.offset),
            elInfo = jQuery(scope.container + " .info-support");
          el.on("ps-scroll-y", function () {
            if (
              scope.type == "globalTemplate" &&
              angular.isDefined(scope.currentType) &&
              scope.currentType != "global"
            )
              return;
            if (
              el.prop("clientHeight") != el.prop("scrollHeight") &&
              el.prop("scrollTop") +
                el.prop("clientHeight") -
                el.prop("scrollHeight") +
                offset >
                0
            ) {
            ...
            if (elInfo.length) {
              (el.prop("scrollTop") > 1500 &&
                elInfo.addClass("slideInDown animated show")) ||
                elInfo.removeClass("slideInDown animated show");
            }
          });
        });
      },
...
nbdApp.directive("nbdScrollTemplateTab", [
  "$timeout",
  function ($timeout) {
    return {
      restrict: "AE",
        ...
        $timeout(function () {
          jQuery(element).sortable({
            ...
            start: function (e, ui) {
              jQuery(this).attr(
                "data-prev-index",
                jQuery(ui.item).attr("data-index")
              );
...
nbdApp.directive("endRepeatColorPicker", [
  "$timeout",
  function ($timeout) {
    return {
      restrict: "A",
...
nbdApp.filter("filterFont", function () {
  return function (fonts, filterFont) {
    ...
    angular.forEach(fonts, function (font, key) {
      var check = [];
      check["limit"] =
        arrFont.length > filterFont.perPage * filterFont.currentPage - 1
          ? false
          : true;
      if (!!filterFont.search) {
        check["name"] =
          font.name.toLowerCase().indexOf(filterFont.search.toLowerCase()) >= 0
            ? true
            : false;
        if (angular.isDefined(font.display_name) && font.display_name != "") {
          check["name"] =
            ...
            (font.display_name
              .toLowerCase()
              .indexOf(filterFont.search.toLowerCase()) >= 0
              ? true
              : false);
        }
      } else {
...
nbdApp.filter("filterArt", function () {
  return function (arts, filterArt) {
    ...
    angular.forEach(arts, function (art, key) {
      var check = [];
      check["limit"] =
        arrArt.length > filterArt.perPage * filterArt.currentPage - 1
          ? false
          : true;
      if (!!filterArt.search) {
        check["name"] =
          art.name.toLowerCase().indexOf(filterArt.search.toLowerCase()) >= 0
            ? true
            : false;
      } else {
        check["name"] = true;
      ...
      if (!!filterArt.currentCat.id || filterArt.currentCat.id === 0) {
        check["cat"] =
          _.includes(art.cat, filterArt.currentCat.id) ||
          _.includes(art.cat, "" + filterArt.currentCat.id)
            ? true
            : false;
      } else {
...
nbdApp.filter("filterBackground", function () {
  return function (backgrounds, filterBackground) {
    var arrBackground = [];
    backgrounds = _.sortBy(backgrounds, [
      function (o) {
        return o.name;
      },
    ]);
    angular.forEach(backgrounds, function (background, key) {
      var check = [];
      check["limit"] =
        arrBackground.length >
        filterBackground.perPage * filterBackground.currentPage - 1
          ? false
          : true;
      if (!!filterBackground.search) {
        check["name"] =
          art.name
            .toLowerCase()
            .indexOf(filterBackground.search.toLowerCase()) >= 0
            ? true
            : false;
      } else {
        check["name"] = true;
      ...
      if (!!filterBackground.currentCat.id) {
        check["cat"] = _.includes(
          background.cat,
          filterBackground.currentCat.id
        )
          ? true
          : false;
      } else {
      ...
      if (check["limit"] && check["name"] && check["cat"])
        arrBackground.push(art);
    });
  ...
  function () {
    return {
      ...
      link: function (scope, element) {
        ...
        var font = new FontFaceObserver(fontName);
        font.load(scope.preview, 3e4).then(
          function () {
...
nbdApp.directive("nbdUploadFile", [
  "$timeout",
  function ($timeout) {
    return {
      restrict: "A",
    ...
    return {
      ...
      link: function (scope, element, attrs) {
        ...
        element.on("dragstart", function (event) {
          ...
          if (
            angular.isDefined(scope.img) &&
            angular.isDefined(scope.img.origin_url)
          ) {
            event.originalEvent.dataTransfer.setData(
              "origin_url",
              scope.img.origin_url
            );
            event.originalEvent.dataTransfer.setData(
              "origin_width",
              scope.img.width
...
nbdApp.directive("boundingCorner", [
  "$timeout",
  function ($timeout) {
    return {
      restrict: "C",
        ...
        $timeout(function () {
          if (scope.type != "") {
            jQuery(element).on("mousedown", function (e) {
              var targetCanvas = document.querySelector(
                "#stage-container-" + scope.stage + " .upper-canvas"
              );
              if (targetCanvas) {
...
nbdApp.directive("rulerGuideline", [
  "$timeout",
  function ($timeout) {
    return {
      restrict: "AE",
            ...
            stageEl.on("mousemove.nbd-move-guideline", function (event) {
              ...
              if (additionalPadding < 0) {
                left =
                  left > 50
                    ? stageElWidth / 2 -
                      (stageElWidth / 2 + 50 - left) / ratio +
                      50
                    : left;
              } else {
                left =
                  stageElWidth / 2 -
                  (stageElWidth / 2 + 50 + additionalPadding - left) / ratio +
                  50;
              }
...
nbdApp.directive("nbdColorPicker", [
  "$timeout",
  function ($timeout) {
    return {
      restrict: "C",
...
nbdApp.directive("nbdClearStage", function () {
  return {
    ...
    link: function (scope, element) {
      jQuery(element).on("click", function () {
        if (
          NBDESIGNCONFIG.nbdesigner_prevent_delete_template_layer == "yes" &&
          !(
            NBDESIGNCONFIG.task == "create" ||
            (NBDESIGNCONFIG.task == "edit" &&
              NBDESIGNCONFIG.design_type == "template")
...
nbdApp.directive("stageCellInner", [
  "$timeout",
  function ($timeout) {
    return {
      restrict: "A",
      link: function (scope, element) {
        $timeout(function () {
          ...
          jQuery(element).on("dragover", function (e) {
            ...
            if (
              e.originalEvent.pageX >
              jQuery(element).offset().left + jQuery(element).width() / 2
            ) {
              jQuery('.stage-space[data-position="' + next + '"]').addClass(
                "active"
              );
              jQuery(
                '.stage-space[data-position="' + position + '"]'
              ).removeClass("active");
              jQuery(element).attr("data-drop-position", next);
            } else {
              jQuery('.stage-space[data-position="' + position + '"]').addClass(
                "active"
              );
              jQuery('.stage-space[data-position="' + next + '"]').removeClass(
                "active"
              );
...
nbdApp.directive("nbdBackground", [
  "$timeout",
  function ($timeout) {
    return {
      restrict: "C",
...
if (NBDESIGNCONFIG.nbdesigner_show_all_template_sides == "yes") {
  nbdApp.directive("nbdTemplateHover", [
    "$timeout",
    function ($timeout) {
      return {
        restrict: "A",
            ...
            $timeout(function () {
              jQuery(element).tooltipster({
                ...
                functionReady: function () {
                  jQuery("#tooltip_content_" + scope.idTmpl).perfectScrollbar(
                    "update"
                  );
                },
              });
...
nbdApp.directive("contextSubMenu", [
  "$timeout",
  "$window",
      ...
      link: function (scope, element) {
        jQuery(element).on("mouseenter", function () {
          ...
          $timeout(function () {
            ...
            if (
              workBenchWidth <
              position.left + subMenuWidth + parentWidth + 15
            ) {
...
nbdApp.directive("nbdPopupTrigger", [
  "$timeout",
  function ($timeout) {
    return {
      restrict: "A",
...
nbdApp.factory("NBDDataFactory", function ($http) {
  return {
    get: function (action, data, callback, progressCallback) {
      ...
      if (data.type == "typography" || data.type == "get_typo")
        url = appConfig.mediaUrl + "/typo";
...
function receiveMessage(event) {
  if (event.origin == window.location.origin) {
    ...
    if (event.data == "start_load_3d_model") {
      jQuery(".preview-3d-wrap-inner .preview-3d-wrap-loading").removeClass(
        "hiddden"
      );
    }
    if (event.data == "loaded_3d_model") {
      jQuery(".preview-3d-wrap-inner .preview-3d-wrap-loading").addClass(
        "hiddden"
      );
...
nbd_window.jQuery('input[name="variation_id"]').on("change", function () {
  if (
    NBDESIGNCONFIG["ui_mode"] == 1 ||
    (NBDESIGNCONFIG["ui_mode"] == 3 && angular.isUndefined(window.nbOption))
  ) {
    if (appConfig.ready) {
      ...
      if (variation_id != "") {
        ...
        if (
          NBDESIGNCONFIG["nbdesigner_hide_button_cart_in_detail_page"] == "yes"
        ) {
          nbd_window
            .jQuery('button[type="submit"].single_add_to_cart_button')
            .hide();
        }
      }
  ...
  if (appConfig.ready) {
    if (NBDESIGNCONFIG["ui_mode"] == 3 || NBDESIGNCONFIG["ui_mode"] == 2) {
      if (nbd_window.jQuery('input[name="variation_id"]').length) {
        setTimeout(function () {
          var variation_id = nbd_window
            .jQuery('input[name="variation_id"]')
            .val();
          if (NBDESIGNCONFIG["variation_id"] == variation_id) return;
          NBDESIGNCONFIG["variation_id"] = variation_id;
          if (variation_id > 0) {
...
jQuery(document).on("change_nbo_options_with_od_option", function () {
  if (appConfig.ready) {
    var scope = angular
      ...
      .scope();
    if (
      NBDESIGNCONFIG["ui_mode"] == 3 ||
      (NBDESIGNCONFIG["ui_mode"] == 2 &&
        scope.settings.nbdesigner_display_product_option == "2")
    ) {
      if (nbd_window.jQuery('input[name="variation_id"]').length) {
        setTimeout(function () {
          var variation_id = nbd_window
...
jQuery(document).on("change_nbo_options", function () {
  if (appConfig.ready) {
    ...
    if (jQuery('input[name="variation_id"]').length) {
      setTimeout(function () {
        scope.printingOptionsAvailable =
          jQuery('input[name="variation_id"]').val() > 0 ? true : false;
        NBDESIGNCONFIG.variation_id = jQuery(
          'input[name="variation_id"]'
        ).val();
      });
...
if (NBDESIGNCONFIG["ui_mode"] == 1) {
  nbd_window
    .jQuery(nbd_window.document)
    .on("change_nbo_extra_od_options", function () {
      if (appConfig.ready) {
        var scope = angular
          .element(document.getElementById("designer-controller"))
          .scope();
  ...
  nbd_window
    .jQuery(nbd_window.document)
    .triggerHandler("trigger_live_chat_from_iframe");
}
if (NBDESIGNCONFIG["ui_mode"] == 3) {
...
nbdApp.controller("MyController", function ($scope, $http) {
  $scope.prompt = "";
  $scope.imageUrls = [];
  $scope.selectedImage = "";
  ...
  const OPENAI_API_KEY = NBDESIGNCONFIG["nbdesigner_open_ai_api_key"];
  ...
  $scope.generateImage = function () {
    ...
    $scope.loadingMessage = "Generating image... Please wait.";
    ...
    $http({
      ...
      .then(function (response) {
        $scope.isLoading = false;
        $scope.loadingMessage = "Image has been generated!";
        const data = response.data;

        if (data && data.data && data.data.length > 0) {
          $scope.imageUrls = data.data.map(function (image) {
            return "data:image/png;base64," + image.b64_json;
          });
        } else {
          $scope.loadingMessage = "No images received!";
        }
      })
      .catch(function () {
        $scope.isLoading = false;
        $scope.loadingMessage = "An error occurred while generating the image!";
      });
  };
