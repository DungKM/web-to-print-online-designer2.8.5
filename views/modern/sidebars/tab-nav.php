<div class="tabs-nav">
    ...
    <ul class="main-tabs" data-tab="tab-1">
        ...
        <?php if ($settings['nbdesigner_open_ai_api_key'] != ''): ?>
            ...
            <li id="nav-ai-chat" data-tour="ai-chat" data-tour-priority="8" class="<?php if ($active_ai_chat) echo 'active'; ?> tab animated <?php echo ($animation_dir); ?> animate1000" ng-click="disableDrawMode();disablePreventClickMode()">
                <i class="icon-nbd icon-nbd-chat">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-chat-left-dots-fill" viewBox="0 0 16 16" style="margin: 0;">
                        <path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H4.414a1 1 0 0 0-.707.293L.854 15.146A.5.5 0 0 1 0 14.793zm5 4a1 1 0 1 0-2 0 1 1 0 0 0 2 0m4 0a1 1 0 1 0-2 0 1 1 0 0 0 2 0m3 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2" />
                    </svg>
                </i>
                <span><?php esc_html_e('AI Chat', 'web-to-print-online-designer'); ?></span>
            </li>
        <?php endif; ?>
