...
class Nbdesigner_Plugin {
    ...
    public function hook(){
        ...
        add_action('woocommerce_blocks_loaded', function() {
            require_once NBDESIGNER_PLUGIN_DIR . 'includes/block_woo/cart-item-blocks-integration.php';
            add_action(
                'woocommerce_blocks_cart_block_registration',
                function( $integration_registry ) {
                    $integration_registry->register( new Cart_Item_Blocks_Integration() );
                }
            );
            add_action(
    ...
    public function woocommerce_hook(){
        ...
        add_action( 'woocommerce_store_api_checkout_order_processed', array( $this, 'set_nbd_order_data' ), 1, 1 );
...
//                }  
    ...
    public function order_design_wcorder($order) {
        // $order          = new WC_Order( $order_id );
...
//                }
    ...
    public function nbdesigner_user_role(){
        ...
        // apply_filters('nbod_admin_role',$admin_role);
